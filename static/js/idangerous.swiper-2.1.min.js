...
var Swiper = function (f, b) {
	...
	function n() {
		...
		a.browser.ie10
			? (a.h.addEventListener(a.wrapper, a.touchEvents.touchStart, z, !1),
			  a.h.addEventListener(document, a.touchEvents.touchMove, A, !1),
			  a.h.addEventListener(document, a.touchEvents.touchEnd, B, !1))
			: (a.support.touch &&
					(a.h.addEventListener(a.wrapper, "touchstart", z, !1),
					a.h.addEventListener(a.wrapper, "touchmove", A, !1),
					a.h.addEventListener(a.wrapper, "touchend", B, !1)),
			  b.simulateTouch &&
					(a.h.addEventListener(a.wrapper, "mousedown", z, !1),
					a.h.addEventListener(document, "mousemove", A, !1),
			...
			for (
				d = [],
					document.querySelectorAll
						...
						: window.jQuery && (d = g(a.container).find("a")),
					c = 0;
				c < d.length;
				c++
			)
	...
	function N(c) {
		...
		c.detail
			...
			? (e = -c.detail)
			: "wheel" == d &&
			  (e = Math.abs(c.deltaX) > Math.abs(c.deltaY) ? -c.deltaX : -c.deltaY);
		b.freeMode
			? (k ? a.getWrapperTranslate("x") : a.getWrapperTranslate("y"),
			  k
					? ((d = a.getWrapperTranslate("x") + e),
					  (e = a.getWrapperTranslate("y")),
					  0 < d && (d = 0),
					  d < -h() && (d = -h()))
					: ((d = a.getWrapperTranslate("x")),
					  (e = a.getWrapperTranslate("y") + e),
					  0 < e && (e = 0),
					  e < -h() && (e = -h())),
			  a.setWrapperTransition(0),
			  a.setWrapperTranslate(d, e, 0),
			  k ? a.updateActiveSlide(d) : a.updateActiveSlide(e))
			: 0 > e
			? a.swipeNext()
			: a.swipePrev();
	...
	function z(c) {
		...
		if (!u || 1 == c.targetTouches.length) {
			...
			a.setWrapperTransition(0);
			a.positions.start = a.positions.current = k
				? a.getWrapperTranslate("x")
				: a.getWrapperTranslate("y");
			k
				? a.setWrapperTranslate(a.positions.start, 0, 0)
				: a.setWrapperTranslate(0, a.positions.start, 0);
	...
	function A(c) {
		if (a.isTouched && !b.onlyExternal && (!u || "mousemove" != c.type)) {
			...
			"undefined" === typeof x &&
				k &&
				(x = !!(
					x || Math.abs(e - a.touches.startY) > Math.abs(d - a.touches.startX)
				));
			"undefined" !== typeof x ||
				k ||
				(x = !!(
			...
			if (x) a.isTouched = !1;
				...
				((c.assignedToSwiper = !0),
				(a.isMoved = !0),
				b.preventLinks && (a.allowLinks = !1),
				b.onSlideClick && (a.allowSlideClick = !1),
				b.autoplay && a.stopAutoplay(),
				...
				a.positions.current =
					(a.touches.current - a.touches.start) * b.touchRatio + a.positions.start;
				...
				if (b.followFinger) {
					b.moveStartThreshold
						? Math.abs(a.touches.current - a.touches.start) > b.moveStartThreshold ||
						  M
							? ((M = !0),
							  k
		...
		if (!b.onlyExternal && a.isTouched) {
			...
			if (a.isMoved) {
				...
				if (0 < a.positions.current) a.swipeReset();
					...
					"toNext" == E &&
						300 >= c &&
						(30 > e || !b.shortSwipes ? a.swipeReset() : a.swipeNext(!0));
					"toPrev" == E &&
						300 >= c &&
						(30 > e || !b.shortSwipes ? a.swipeReset() : a.swipePrev(!0));
					f = 0;
					if ("auto" == b.slidesPerView) {
						for (
							...
							if (
								((m = k ? a.slides[q].getWidth(!0) : a.slides[q].getHeight(!0)),
								(g += m),
								g > d)
							) {
								f = m;
	...
	function I(c, d, e) {
		function f() {
			...
			if ((p = "toNext" == l ? g > c : g < c))
				k
					? a.setWrapperTranslate(Math.round(g), 0)
					: a.setWrapperTranslate(0, Math.round(g)),
					(a._DOMAnimating = !0),
			...
			(a.support.transitions
				? b.queueEndCallbacks
					? a._queueEndCallbacks ||
					  ((a._queueEndCallbacks = !0), a.wrapperTransitionEnd(b.onSlideChangeEnd))
	...
	if (
		...
		a.touchEvents = {
			touchStart:
				a.support.touch || !b.simulateTouch
					? "touchstart"
					: a.browser.ie10
					? "MSPointerDown"
					: "mousedown",
		...
		for (q = a.container.childNodes.length - 1; 0 <= q; q--)
			if (a.container.childNodes[q].className)
				for (
					C = a.container.childNodes[q].className.split(" "), s = 0;
					s < C.length;
					s++
				)
		...
		a._extendSwiperSlide = function (c) {
			c.append = function () {
				b.loop
					? (c.insertAfter(a.slides.length - a.loopedSlides),
			...
			c.prepend = function () {
				b.loop
					? (a.wrapper.insertBefore(c, a.slides[a.loopedSlides]),
					  a.removeLoopedSlides(),
					  a.calcSlides(),
					  a.createLoop())
		...
		a.calcSlides = function (c) {
			...
			for (var e = 0; e < a.wrapper.childNodes.length; e++)
				if (a.wrapper.childNodes[e].className)
					for (
						var f = a.wrapper.childNodes[e].className.split(" "), g = 0;
						g < f.length;
						g++
					)
			...
			d &&
				...
				t(),
				a.updateActiveSlide(),
				b.createPagination && a.params.pagination && a.createPagination(),
		...
		a.appendSlide = function (b, d, e) {
			if (b)
				return b.nodeType
					? a._extendSwiperSlide(b).append()
					: a.createSlide(b, d, e).append();
		};
		a.prependSlide = function (b, d, e) {
			if (b)
				return b.nodeType
					? a._extendSwiperSlide(b).prepend()
		...
		a.removeLastSlide = function () {
			return 0 < a.slides.length
				? (b.loop
						? (a.slides[a.slides.length - 1 - a.loopedSlides].remove(),
						  a.removeLoopedSlides(),
						  a.calcSlides(),
						  a.createLoop())
						: a.slides[a.slides.length - 1].remove(),
				  !0)
				: !1;
		};
		...
		a.browser.ie10 &&
			!b.onlyExternal &&
			(k
				? a.wrapper.classList.add("swiper-wp8-horizontal")
		...
		a.init = function (c, d) {
			...
			if (e !== a.width || f !== a.height || c) {
				...
				if ("auto" === b.slidesPerView) {
					...
					0 < b.offsetPxBefore &&
						(k
							? (a.wrapperLeft = b.offsetPxBefore)
							: (a.wrapperTop = b.offsetPxBefore));
					0 < b.offsetPxAfter &&
						(k
							? (a.wrapperRight = b.offsetPxAfter)
							: (a.wrapperBottom = b.offsetPxAfter));
					b.centeredSlides &&
						(k
							? ((a.wrapperLeft = (l - this.slides[0].getWidth(!0)) / 2),
							  (a.wrapperRight =
									(l - a.slides[a.slides.length - 1].getWidth(!0)) / 2))
							: ((a.wrapperTop = (l - a.slides[0].getHeight(!0)) / 2),
							  (a.wrapperBottom =
									(l - a.slides[a.slides.length - 1].getHeight(!0)) / 2)));
					k
						? (0 <= a.wrapperLeft && (e.style.paddingLeft = a.wrapperLeft + "px"),
						  0 <= a.wrapperRight && (e.style.paddingRight = a.wrapperRight + "px"))
						: (0 <= a.wrapperTop && (e.style.paddingTop = a.wrapperTop + "px"),
						  0 <= a.wrapperBottom &&
					...
					k
						? ((y = g + a.wrapperRight + a.wrapperLeft),
						  (e.style.width = g + "px"),
						  (e.style.height = a.height + "px"))
						: ((y = h + a.wrapperTop + a.wrapperBottom),
					...
					if (b.calculateHeight) {
						...
						(s = k ? a.height : a.height / b.slidesPerView),
					...
					0 < b.offsetSlidesBefore &&
						(k
							? (a.wrapperLeft = p * b.offsetSlidesBefore)
							: (a.wrapperTop = p * b.offsetSlidesBefore));
					0 < b.offsetSlidesAfter &&
						(k
							? (a.wrapperRight = p * b.offsetSlidesAfter)
							: (a.wrapperBottom = p * b.offsetSlidesAfter));
					0 < b.offsetPxBefore &&
						(k
							? (a.wrapperLeft = b.offsetPxBefore)
							: (a.wrapperTop = b.offsetPxBefore));
					...
					b.centeredSlides &&
						(k
							...
							: ((a.wrapperTop = (l - p) / 2), (a.wrapperBottom = (l - p) / 2)));
					k
						? (0 < a.wrapperLeft && (e.style.paddingLeft = a.wrapperLeft + "px"),
						  0 < a.wrapperRight && (e.style.paddingRight = a.wrapperRight + "px"))
						: (0 < a.wrapperTop && (e.style.paddingTop = a.wrapperTop + "px"),
						  0 < a.wrapperBottom &&
								(e.style.paddingBottom = a.wrapperBottom + "px"));
					y = k
						? n + a.wrapperRight + a.wrapperLeft
						: g + a.wrapperTop + a.wrapperBottom;
					e.style.width = n + "px";
					e.style.height = g + "px";
					m = 0;
					a.snapGrid = [];
		...
		a.resizeFix = function (c) {
			...
			if (!b.freeMode)
				b.loop
					? a.swipeTo(a.activeLoopIndex, 0, !1)
					: a.swipeTo(a.activeIndex, 0, !1);
			else if (
				(k ? a.getWrapperTranslate("x") : a.getWrapperTranslate("y")) < -h()
			) {
				c = k ? -h() : 0;
				var d = k ? 0 : -h();
				a.setWrapperTransition(0);
		...
		a.destroy = function (c) {
			a.browser.ie10
				...
				: (a.support.touch &&
						(a.h.removeEventListener(a.wrapper, "touchstart", z, !1),
						a.h.removeEventListener(a.wrapper, "touchmove", A, !1),
						a.h.removeEventListener(a.wrapper, "touchend", B, !1)),
				  b.simulateTouch &&
						(a.h.removeEventListener(a.wrapper, "mousedown", z, !1),
						a.h.removeEventListener(document, "mousemove", A, !1),
		...
		a.updateActiveSlide = function (c) {
			if (a.initialized && 0 != a.slides.length) {
				...
				0 < c && (c = 0);
				"undefined" == typeof c &&
					(c = k ? a.getWrapperTranslate("x") : a.getWrapperTranslate("y"));
				if ("auto" == b.slidesPerView) {
					if (((a.activeIndex = a.slidesGrid.indexOf(-c)), 0 > a.activeIndex)) {
						for (
							var d = 0;
							d < a.slidesGrid.length - 1 &&
							!(-c > a.slidesGrid[d] && -c < a.slidesGrid[d + 1]);
							d++
						);
				...
				if (a.slides[a.activeIndex]) {
					...
					for (d = 0; d < a.slides.length; d++)
						(a.slides[d].className = a.slides[d].className
							.replace(e, "")
							.replace(f, "")),
					...
					b.loop
						? ((d = a.loopedSlides),
						  (a.activeLoopIndex = a.activeIndex - d),
		...
		a.createPagination = function (c) {
			...
			for (var f = 0; f < e; f++)
				d +=
					...
					b.paginationElement +
					">";
			a.paginationContainer = b.pagination.nodeType
				? b.pagination
				: g(b.pagination)[0];
			a.paginationContainer.innerHTML = d;
			a.paginationButtons = [];
			document.querySelectorAll
				? (a.paginationButtons = a.paginationContainer.querySelectorAll(
						"." + b.paginationElementClass
				  ))
				: window.jQuery &&
				  (a.paginationButtons = g(a.paginationContainer).find(
						"." + b.paginationElementClass
				  ));
		...
		a.updatePagination = function (c) {
			if (b.pagination && !(1 > a.slides.length)) {
				if (document.querySelectorAll)
					var d = a.paginationContainer.querySelectorAll(
						"." + b.paginationActiveClass
					);
				else
					window.jQuery &&
						(d = g(a.paginationContainer).find("." + b.paginationActiveClass));
		...
		a.createLoop = function () {
			if (0 != a.slides.length) {
				...
				for (e = 0; e < a.slides.length; e++)
					(e < a.loopedSlides || e >= a.slides.length - a.loopedSlides) &&
		...
		a.fixLoop = function () {
			if (a.activeIndex < a.loopedSlides) {
				...
				a.activeIndex > a.slides.length - 2 * b.slidesPerView &&
					((c = -a.slides.length + a.activeIndex + a.loopedSlides),
					a.swipeTo(c, 0, !1));
		};
		a.loadSlides = function () {
			...
			a.activeLoaderIndex = 0;
			for (
				var d = b.loader.slides,
					e = b.loader.loadAllSlides
						? d.length
		...
		a.reloadSlides = function () {
			...
			if (!(0 > d || d > c.length - 1)) {
				...
				var e = Math.max(0, d - b.slidesPerView * b.loader.surroundGroups),
					f = Math.min(
						d + b.slidesPerView * (1 + b.loader.surroundGroups) - 1,
						c.length - 1
					);
				0 < d &&
					((d = -p * (d - e)),
				...
				if ("reload" === b.loader.logic) {
					...
					for (var g = 1e3, h = 0, d = 0; d < a.slides.length; d++) {
						...
						l < e || l > f
							? a.wrapper.removeChild(a.slides[d])
							: ((g = Math.min(l, g)), (h = Math.max(l, h)));
					}
					for (d = e; d <= f; d++)
						d < g &&
							((e = document.createElement(b.slideElement)),
							(e.className = b.slideClass),
							e.setAttribute("data-swiperindex", d),
							(e.innerHTML = c[d]),
		...
		b.loop || 0 < b.initialSlide
			? a.swipeTo(b.initialSlide, 0, !1)
			: a.updateActiveSlide(0);
...
Swiper.prototype = {
	...
	getWrapperTranslate: function (f) {
		var b = this.wrapper,
			...
			n = window.WebKitCSSMatrix
				? new WebKitCSSMatrix(window.getComputedStyle(b, null).webkitTransform)
			  ...
			  "y" == f &&
					(h =
						16 == g.length
							...
							? n.m42
							: parseFloat(g[5])))
			: ("x" == f && (h = parseFloat(b.style.left, 10) || 0),
		...
		this.params.useCSS3Transforms
			? this.support.transforms3d
				...
				: ((h.webkitTransform =
						...
						h.transform =
							"translate(" + f + "px, " + b + "px)"),
				  this.support.transforms || ((h.left = f + "px"), (h.top = b + "px")))
	...
	h: {
		getWidth: function (f, b) {
			...
			if (isNaN(h) || 0 < g.indexOf("%"))
				h =
					f.offsetWidth -
					parseFloat(
						window.getComputedStyle(f, null).getPropertyValue("padding-left")
					) -
					parseFloat(
						window.getComputedStyle(f, null).getPropertyValue("padding-right")
					);
			b &&
				(h +=
					parseFloat(
		...
		getHeight: function (f, b) {
			...
			if (isNaN(h) || 0 < g.indexOf("%"))
				h =
					f.offsetHeight -
					parseFloat(
						window.getComputedStyle(f, null).getPropertyValue("padding-top")
					) -
					parseFloat(
						window.getComputedStyle(f, null).getPropertyValue("padding-bottom")
					);
			b &&
				(h +=
					parseFloat(
		...
		addEventListener: function (f, b, g, h) {
			f.addEventListener
				? f.addEventListener(b, g, h)
				: f.attachEvent && f.attachEvent("on" + b, g);
		},
		removeEventListener: function (f, b, g, h) {
			f.removeEventListener
				? f.removeEventListener(b, g, h)
				: f.detachEvent && f.detachEvent("on" + b, g);
		},
	},
	...
	setTransition: function (f, b) {
		...
		g.webkitTransitionDuration =
			g.MsTransitionDuration =
			g.msTransitionDuration =
			g.MozTransitionDuration =
			g.OTransitionDuration =
