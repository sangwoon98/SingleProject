		...
		t.extend(t.validator, {
			...
			prototype: {
				...
				addWrapper: function (t) {
					return (
						this.settings.wrapper && (t = t.add(t.parent(this.settings.wrapper))), t
					);
				},
				...
				optional: function (e) {
					...
					return (
						!t.validator.methods.required.call(this, i, e) && "dependency-mismatch"
					);
				},
			...
			methods: {
				...
				number: function (t, e) {
					return (
						this.optional(e) || /^-?(?:\d+|\d{1,3}(?:,\d{3})+)?(?:\.\d+)?$/.test(t)
					);
				},
				digits: function (t, e) {
