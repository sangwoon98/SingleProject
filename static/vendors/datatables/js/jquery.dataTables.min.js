		...
		var j = function (e) {
			...
			function ta(a, b, c, d) {
				...
				if (b)
					for (i = b.length - 1; 0 <= i; i--) {
						var j = b[i].aTargets;
						h.isArray(j) ||
							D(a, 1, "aTargets must be an array of targets, not a " + typeof j);
						f = 0;
							...
							(f = a.aoData[g]),
								...
								w &&
									...
									"" !== p &&
										...
										null === e.sType
											? (e.sType = p)
											: e.sType != p && "html" != e.sType && (e.sType = "string"))),
								e.mRender
									? (m.innerHTML = v(a, g, c, "display"))
									: e.mData !== c && (m.innerHTML = v(a, g, c, "display")),
								o &&
									((p = S(a, g, c)), (m.innerHTML = p), e.bUseRendered && F(a, g, c, p)),
			...
			function va(a) {
				...
				"" !== a.oClasses.sFooterTH &&
					h(a.nTFoot).children("tr").children("th").addClass(a.oClasses.sFooterTH);
				if (null !== a.nTFoot) {
					...
					if (0 !== a.aiDisplay.length) {
						...
						for (; g < d; g++) {
							...
							if (0 !== f) {
								...
								e._sRowStripe != o &&
									(h(j).removeClass(e._sRowStripe).addClass(o), (e._sRowStripe = o));
							}
			...
			function xa(a) {
				...
				for (
					var c = a.nTableWrapper, d = a.sDom.split(""), i, f, g, e, w, o, k, m = 0;
					m < d.length;
					m++
				) {
					f = 0;
			...
			function Ia(a) {
				for (
					var b = j.ext.afnFiltering, c = r(a, "bSearchable"), d = 0, i = b.length;
					d < i;
					d++
				)
			...
			function La(a) {
				var b = a.nScrollHead.getElementsByTagName("div")[0],
					...
					n = [],
					l =
						null !== a.nTFoot ? a.nScrollFoot.getElementsByTagName("div")[0] : null,
				...
				if (h(a.nTable).outerWidth() < i) {
					g =
						d.scrollHeight > d.offsetHeight || "scroll" == h(d).css("overflow-y")
			...
			function da(a) {
				...
				if (
					...
					"" !== a.oScroll.sX && "" !== a.oScroll.sXInner
						...
						: "" !== a.oScroll.sX
						? ((b.style.width = ""),
						  h(b).width() < e.offsetWidth && (b.style.width = q(e.offsetWidth)))
						: "" !== a.oScroll.sY
						...
						q[c].bSortable
							? 0 < o.length && o[0][0] == c
								...
								: i.setAttribute(
										"aria-label",
										e +
											("asc" == q[c].asSorting[0] ? G.sSortAscending : G.sSortDescending)
								  )
			...
			this.fnDestroy = function (a) {
				...
				b.nTable != b.nTHead.parentNode &&
					(h(b.nTable).children("thead").remove(), b.nTable.appendChild(b.nTHead));
				b.nTFoot &&
				...
				b.bJUI &&
					(h(
						"th span." + b.oClasses.sSortIcon + ", td span." + b.oClasses.sSortIcon,
						b.nTHead
					).remove(),
			...
			this.fnFilter = function (a, b, c, d, e, f) {
				...
				if (g.oFeatures.bFilter) {
					...
					if (b === n || null === b) {
						if (
							(K(g, { sSearch: a + "", bRegex: c, bSmart: d, bCaseInsensitive: f }, 1),
							e && g.aanFeatures.f)
						) {
							b = g.aanFeatures.f;
							c = 0;
				...
				fnUpdate: function (e) {
					if (e.aanFeatures.p)
						for (
							...
							if ((k = j[l].firstChild))
								(k.className =
									0 === e._iDisplayStart ? h.sPagePrevDisabled : h.sPagePrevEnabled),
									(k = k.nextSibling),
									(k.className =
