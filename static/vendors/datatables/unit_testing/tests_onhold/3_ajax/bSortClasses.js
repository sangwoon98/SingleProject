...
$(document).ready(function () {
	...
	oTest.fnWaitTest("Sorting classes are applied by default", null, function () {
	...
	oTest.fnWaitTest(
		...
		function () {
			return (
				$("#example tbody tr:eq(0) td:eq(0)").hasClass("sorting_1") &&
	...
	oTest.fnWaitTest(
		...
		function () {
			return (
				$("#example tbody tr:eq(0) td:eq(0)").hasClass("sorting_1") == false &&
	...
	oTest.fnWaitTest("Sorting class 1 was added", null, function () {
