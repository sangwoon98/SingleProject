...
$(document).ready(function () {
	...
	var oTable = $("#example").dataTable({
		...
		bAutoWidth: false,
		aoColumns: [null, { sWidth: "40%" }, null, null, null],
	});
	...
	oTest.fnWaitTest(
		...
		function () {
			...
			oTable = $("#example").dataTable({
				sAjaxSource: "../../../examples/ajax/sources/arrays.txt",
				bAutoWidth: false,
				aoColumns: [null, null, { sWidth: "20%" }, { sWidth: "30%" }, null],
			});
		},
		function () {
			var bReturn =
	...
	oTest.fnWaitTest(
		...
		function () {
			...
			oTable = $("#example").dataTable({
				sAjaxSource: "../../../examples/ajax/sources/arrays.txt",
				aoColumns: [null, null, null, { sWidth: "40%" }, null],
			});
		},
		function () {
			...
			if (a3 > a0 && a3 > a1 && a3 > a2 && a3 > a4) return true;
			else return false;
		}
	);
