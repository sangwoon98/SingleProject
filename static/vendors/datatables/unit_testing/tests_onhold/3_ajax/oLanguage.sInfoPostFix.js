...
$(document).ready(function () {
	...
	oTest.fnTest("Width no post fix, the basic info shows", null, function () {
	...
	oTest.fnTest("Info empty language default is in the DOM", null, function () {
		return (document.getElementById("example_info").innerHTML =
			"Showing 1 to 10 of 57 entries unit test");
	});
	...
	oTest.fnWaitTest(
		...
		function () {
			return (document.getElementById("example_info").innerHTML =
				"Showing 1 to 10 of 57 entries unit _START_ _END_ _TOTAL_ test");
		}
	);
	...
	oTest.fnWaitTest(
		...
		function () {
			return (document.getElementById("example_info").innerHTML =
				"Showing 0 to 0 of 0 entries unit (filtered from 57 total entries) test");
		}
	);
