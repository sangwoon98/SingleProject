...
$(document).ready(function () {
	...
	oTest.fnTest(
		...
		function () {
			...
			$("#example").dataTable({
				aaData: gaaData,
				aoColumns: [null, null, { sClass: "unittest" }, null, null],
			});
		},
		function () {
	...
	oTest.fnTest("Add a class to a single column - third row", null, function () {
		return $("#example tbody tr:eq(3) td:eq(2)").hasClass("unittest");
	});

	oTest.fnTest("Add a class to a single column - last row", null, function () {
