...
$(document).ready(function () {
	...
	oTest.fnTest(
		...
		function () {
			var bReturn =
				oSettings.aoPreSearchCols[0].sSearch == 0 &&
				!oSettings.aoPreSearchCols[0].bRegex &&
				oSettings.aoPreSearchCols[1].sSearch == 0 &&
				!oSettings.aoPreSearchCols[1].bRegex &&
				oSettings.aoPreSearchCols[2].sSearch == 0 &&
				!oSettings.aoPreSearchCols[2].bRegex &&
				oSettings.aoPreSearchCols[3].sSearch == 0 &&
				!oSettings.aoPreSearchCols[3].bRegex &&
				oSettings.aoPreSearchCols[4].sSearch == 0 &&
				!oSettings.aoPreSearchCols[4].bRegex;
			return bReturn;
		}
	);
	...
	oTest.fnTest(
		...
		function () {
			...
			oTable = $("#example").dataTable({
				aaData: gaaData,
				aoSearchCols: [null, { sSearch: "Mozilla" }, null, { sSearch: "1" }, null],
			});
		},
		function () {
			return (
