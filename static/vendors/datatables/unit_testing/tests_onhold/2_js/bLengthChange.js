...
$(document).ready(function () {
	...
	oTest.fnTest("Length div exists by default", null, function () {
		return document.getElementById("example_length") != null;
	});

	oTest.fnTest("Four default options", null, function () {
		return $("select[name=example_length] option").length == 4;
	});

	oTest.fnTest("Default options", null, function () {
	...
	oTest.fnTest("Info takes length into account", null, function () {
		return (
