...
$(document).ready(function () {
	...
	$("#example").dataTable({
		aaData: [[null], [5], ["1a"], [new Date(0)]],
		aoColumns: [{ sTitle: "Test" }],
	});

	oTest.fnTest("Sorting works - first cell is empty", null, function () {
		return $("#example tbody tr:eq(0) td:eq(0)").html() === "";
	});

	oTest.fnTest("Second cell is 1a", null, function () {
		return $("#example tbody tr:eq(1) td:eq(0)").html() === "1a";
	});

	oTest.fnTest("Third cell is 5", null, function () {
