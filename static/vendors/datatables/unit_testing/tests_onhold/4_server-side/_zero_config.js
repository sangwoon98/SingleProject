...
oTest.fnWaitTest("jQuery.dataTable function", null, function () {
	return typeof jQuery().dataTable == "function";
});

oTest.fnWaitTest("jQuery.dataTableSettings storage array", null, function () {
	return typeof jQuery().dataTableSettings == "object";
});

oTest.fnWaitTest("jQuery.dataTableExt plugin object", null, function () {
...
$(document).ready(function () {
	...
	oTest.fnWaitTest("Filtering div exists", null, function () {
		return document.getElementById("example_filter") != null;
	});

	oTest.fnWaitTest("Information div exists", null, function () {
		return document.getElementById("example_info") != null;
	});

	oTest.fnWaitTest("Pagination div exists", null, function () {
		return document.getElementById("example_paginate") != null;
	});

	oTest.fnWaitTest("Processing div is off by default", null, function () {
	...
	oTest.fnWaitTest("Initial sort occured", null, function () {
	 ...
	 * Information element
	 */
	oTest.fnWaitTest("Information on zero config", null, function () {
		return (
	...
	oTest.fnWaitTest("Filter 'W' - info", null, function () {
		return (
			document.getElementById("example_info").innerHTML ==
	...
	oTest.fnWaitTest("Filter 'Win' - sorting column 1 info", null, function () {
		return (
			document.getElementById("example_info").innerHTML ==
			"Showing 1 to 10 of 31 entries (filtered from 57 total entries)"
		);
	...
	oTest.fnWaitTest("Filter 'nothinghere' - info", null, function () {
		return (
			document.getElementById("example_info").innerHTML ==
