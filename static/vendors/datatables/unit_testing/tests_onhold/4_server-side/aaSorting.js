...
$(document).ready(function () {
	...
	oTest.fnWaitTest("Default sorting is single column", null, function () {
		return (
			oSettings.aaSorting.length == 1 && typeof oSettings.aaSorting[0] == "object"
		);
	});

	oTest.fnWaitTest("Default sorting is first column asc", null, function () {
		return (
			oSettings.aaSorting[0].length == 3 &&
			oSettings.aaSorting[0][0] == 0 &&
			oSettings.aaSorting[0][1] == "asc"
		);
	});

	oTest.fnWaitTest("Sorting is applied", null, function () {
