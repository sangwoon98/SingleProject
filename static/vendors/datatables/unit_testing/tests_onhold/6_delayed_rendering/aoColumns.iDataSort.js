...
$(document).ready(function () {
	...
	var oTable = $("#example").dataTable({
		...
		bDeferRender: true,
		aoColumns: [null, { iDataSort: 4 }, null, null, null],
	});
	var oSettings = oTable.fnSettings();

	oTest.fnWaitTest("Sorting on first column is uneffected", null, function () {
	...
	oTest.fnWaitTest(
		...
		function () {
			...
			oTable = $("#example").dataTable({
				sAjaxSource: "../../../examples/ajax/sources/arrays.txt",
				bDeferRender: true,
				aoColumns: [null, { iDataSort: 4 }, null, null, { iDataSort: 1 }],
			});
		},
		function () {
			return $("#example tbody tr:eq(0) td:eq(0)").html() == "Gecko";
