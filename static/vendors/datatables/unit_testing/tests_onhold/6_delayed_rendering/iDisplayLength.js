...
$(document).ready(function () {
	...
	oTest.fnWaitTest("Default length is ten", null, function () {
		return $("#example tbody tr").length == 10;
	});

	oTest.fnWaitTest("Select menu shows 10", null, function () {
	...
	oTest.fnWaitTest("Select menu shows 25", null, function () {
