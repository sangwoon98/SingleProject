...
$(document).ready(function () {
	...
	oTest.fnTest("Default sorting is single column", null, function () {
		return (
			oSettings.aaSorting.length == 1 && typeof oSettings.aaSorting[0] == "object"
		);
	});

	oTest.fnTest("Default sorting is first column asc", null, function () {
		return (
	...
	oTest.fnTest("Sorting is applied", null, function () {
