...
$(document).ready(function () {
	...
	oTest.fnTest("Default DOM varaible", null, function () {
		return oSettings.sDom == "lfrtip";
	});

	oTest.fnTest("Default DOM in document", null, function () {
	...
	oTest.fnTest("Check example 1 in DOM", null, function () {
