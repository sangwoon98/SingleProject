...
$(document).ready(function () {
	...
	oTest.fnTest("Default row striping is applied", null, function () {
		return (
			$("#example tbody tr:eq(0)").hasClass("odd") &&
	...
	oTest.fnTest(
		...
		function () {
			return (
				$("#example tbody tr:eq(0)").hasClass("gradeA") &&
	...
	oTest.fnTest(
		...
		function () {
			return (
				$("#example tbody tr:eq(0)")[0].className == "gradeA" &&
	...
	oTest.fnTest(
		...
		function () {
			return (
				$("#example tbody tr:eq(0)").hasClass("test1") &&
