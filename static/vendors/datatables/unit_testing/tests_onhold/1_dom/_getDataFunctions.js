...
$(document).ready(function () {
	...
	oTest.fnTest(
		...
		function () {
			return test.length === 3 && test[0] === 1 && test[1] === 2 && test[2] === 3;
		}
	);
	...
	oTest.fnTest(
		...
		function () {
			return test.length === 2 && test[0] === true && test[1] === false;
		}
	);
	...
	oTest.fnTest(
		...
		function () {
			return test.length === 2 && test[0] === undefined && test[1] === undefined;
		}
	);
	...
	oTest.fnTest(
		...
		function () {
			return (
				test.length === 3 && test[0] === true && test[1] === false && test[2] === 1
			);
		}
	);
