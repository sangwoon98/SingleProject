...
$(document).ready(function () {
	...
	oTest.fnTest("Sorting is on by default", null, function () {
		return $("#example tbody td:eq(0)").html() == "Gecko";
	});

	oTest.fnTest("Sorting Asc by default class applied", null, function () {
	...
	oTest.fnTest("Sorting class removed from first column", null, function () {
		return $("#example thead th:eq(0)").hasClass("sorting_asc") != true;
	});

	oTest.fnTest("Sorting asc class applied to second column", null, function () {
	...
	oTest.fnTest("Sorting desc class applied to second column", null, function () {
	...
	oTest.fnTest("Disabled classes applied", null, function () {
