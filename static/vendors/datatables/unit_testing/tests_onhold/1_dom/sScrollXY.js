...
$(document).ready(function () {
	...
	oTest.fnWaitTest("Footer follows x-scrolling", null, function () {
	...
	oTest.fnWaitTest("Filtering has no effect on x-scroll", null, function () {
	...
	oTest.fnWaitTest(
		...
		function () {
			return (
				$("div.dataTables_scrollBody").scrollLeft() ==
				$("div.dataTables_scrollHead").scrollLeft()
			);
		}
	);

	oTest.fnTest("Footer also tracked all the way", null, function () {
		return (
			$("div.dataTables_scrollBody").scrollLeft() ==
			$("div.dataTables_scrollFoot").scrollLeft()
		);
	});
