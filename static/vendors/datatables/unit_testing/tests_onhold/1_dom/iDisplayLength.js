...
$(document).ready(function () {
	...
	oTest.fnTest("Default length is ten", null, function () {
		return $("#example tbody tr").length == 10;
	});

	oTest.fnTest("Select menu shows 10", null, function () {
	...
	oTest.fnTest("Select menu shows 25", null, function () {
	...
	oTest.fnTest("Select menu shows 10 (since 23 is unknow)", null, function () {
		return $("#example_length select").val() == 10;
	});
