...
$(document).ready(function () {
	...
	oTest.fnTest("Default is put into DOM", null, function () {
		var anChildren = $("label", oSettings.aanFeatures.l[0])[0].childNodes;
		var bReturn =
			anChildren[0].nodeValue == "Show " && anChildren[2].nodeValue == " entries";
		return bReturn;
	});
	...
	oTest.fnTest(
		...
		function () {
			var anChildren = $("label", oSettings.aanFeatures.l[0])[0].childNodes;
			var bReturn =
				anChildren[0].nodeValue == "unit " && anChildren[2].nodeValue == " test";
			return bReturn;
		}
	);
