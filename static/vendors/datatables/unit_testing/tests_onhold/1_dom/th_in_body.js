...
oTest.fnStart(
	"Sanity checks for DataTables with DOM data and a TH in the body"
);
...
$(document).ready(function () {
	...
	/* Basic checks */
	oTest.fnTest("Length changing div exists", null, function () {
	...
	oTest.fnTest("10 rows shown on the first page", null, function () {
