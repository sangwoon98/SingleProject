			...
			return (
							...
							this.options.axes &&
								...
								(e = function () {
									...
									for (
										...
										n.push(
											this.measureText(this.data[r].text, -this.options.xLabelAngle).height
										);
									return n;
								}.call(this)),
				...
				(r.prototype.drawGoals = function () {
					...
					for (n = r = 0, i = s.length; r < i; n = ++r)
						(t = s[n]),
							(e =
								this.options.goalLineColors[n % this.options.goalLineColors.length]),
				...
				(r.prototype.drawEvents = function () {
					...
					for (n = r = 0, i = s.length; r < i; n = ++r)
						(t = s[n]),
							(e =
								this.options.eventLineColors[n % this.options.eventLineColors.length]),
						...
						(e = function (e, t) {
							...
							return (
								...
								c.options.xLabelAngle !== 0 &&
									((a =
										-0.5 * f.width * Math.cos((c.options.xLabelAngle * Math.PI) / 180)),
									n.transform("t" + a + ",0...")),
								(r = n.getBBox()),
					...
					for (
						...
						(u = this.data[this.data.length - 1 - e]),
							...
							this.options.xLabelAngle !== 0 &&
								((i =
									-0.5 * a.width * Math.cos((this.options.xLabelAngle * Math.PI) / 180)),
								t.transform("t" + i + ",0...")),
			...
			return (
				...
				(r.prototype.setLabels = function (e, t) {
					...
					return (
						...
						this.text1.attr({
							transform:
								"S" + u + "," + u + "," + (o.x + o.width / 2) + "," + (o.y + o.height),
						}),
