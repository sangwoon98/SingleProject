tinymce.PluginManager.add("textcolor", function (e) {
	...
	function n() {
		...
		for (
			n = t(),
				...
				o = n.length - 1,
				r = e.settings.textcolor_rows || 5,
				l = e.settings.textcolor_cols || 8,
				s = 0;
			r > s;
			s++
		) {
	...
	function i(t) {
		var n,
			i = this.parent();
		(n = t.target.getAttribute("data-mce-color")) &&
			(i.hidePanel(),
			(n = "#" + n),
			i.color(n),
			e.execCommand(i.settings.selectcmd, !1, n));
	}
	function a() {
		var t = this;
