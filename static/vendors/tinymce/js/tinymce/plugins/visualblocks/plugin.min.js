	...
	window.NodeList &&
		(e.addCommand("mceVisualBlocks", function () {
			...
			i ||
				...
				e.getDoc().getElementsByTagName("head")[0].appendChild(n)),
				...
				(r = e.dom.hasClass(e.getBody(), "mce-visualblocks")),
				a && a.active(o.hasClass(e.getBody(), "mce-visualblocks")),
				e.fire("VisualBlocks");
		}),
		...
		e.on("init", function () {
			e.settings.visualblocks_default_state &&
				e.execCommand("mceVisualBlocks", !1, null, { skip_focus: !0 });
		}),
