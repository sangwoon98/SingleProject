	...
	r(l, [c, d], function (e, t) {
		...
		return function (i, o) {
			function a() {
				var e = 0;
				(R = []),
					r(["thead", "tbody", "tfoot"], function (t) {
						var i = H.select("> " + t + " tr", o);
						r(i, function (i, o) {
							(o += e),
								r(H.select("> td, > th", i), function (e, r) {
									var i, a, s, l;
									if (R[o]) for (; R[o][r]; ) r++;
			...
			function c(e, t, n) {
				e &&
					((n = parseInt(n, 10)),
					1 === n ? e.removeAttribute(t, 1) : e.setAttribute(t, n, 1));
			}
			function d(e) {
				...
				return (
					r(o.rows, function (t) {
						r(t.cells, function (n) {
							return H.hasClass(n, "mce-item-selected") || n == P.elm
								? (e.push(t), !1)
								: void 0;
						});
					}),
			...
			function p(n) {
				var o,
					a = {};
				return (
					i.settings.table_clone_elements !== !1 &&
						(a = e.makeMap(
							(
								i.settings.table_clone_elements ||
					...
					e.walk(
						...
						function (e) {
							var i;
							return 3 == e.nodeType
								? (r(H.getParents(e.parentNode, null, n).reverse(), function (e) {
										a[e.nodeName] &&
											((e = s(e, !1)), o ? i && i.appendChild(e) : (o = i = e), (i = e));
								  }),
								  i && (i.innerHTML = t.ie ? "&nbsp;" : '<br data-mce-bogus="1" />'),
								  !1)
								: void 0;
						},
						"childNodes"
					...
					c(n, "rowSpan", 1),
					c(n, "colSpan", 1),
					o ? n.appendChild(o) : t.ie || (n.innerHTML = '<br data-mce-bogus="1" />'),
					n
				);
			}
			function m() {
				var e = H.createRng(),
					t;
				return (
					r(H.select("tr", o), function (e) {
						0 === e.cells.length && H.remove(e);
					}),
					0 === H.select("tr", o).length
						? (e.setStartBefore(o),
						  e.setEndBefore(o),
						  M.setRng(e),
						  H.remove(o),
						  void 0)
						: (r(H.select("thead,tbody,tfoot", o), function (e) {
								0 === e.rows.length && H.remove(e);
						  }),
						  a(),
						  (t = R[Math.min(R.length - 1, A.y)]),
						  t && (M.select(t[Math.min(t.length - 1, A.x)].elm, !0), M.collapse(!0)),
						  void 0)
				);
			}
			function h(e, t, n, r) {
				...
				for (i = R[t][e].elm.parentNode, a = 1; n >= a; a++)
					if ((i = H.getNext(i, "tr"))) {
						...
						if (-1 == o)
							for (s = 1; r >= s; s++) i.insertBefore(p(i.cells[0]), i.cells[0]);
					}
			}
			function g() {
				r(R, function (e, t) {
			...
			function v(t, n, i) {
				...
				if (
					(t
						? ((o = S(t)), (s = o.x), (u = o.y), (f = s + (n - 1)), (p = u + (i - 1)))
						: ((A = B = null),
						  r(R, function (e, t) {
								r(e, function (e, n) {
					...
					for (
						...
						for (h = s; f >= h; h++)
							R[v] &&
								...
								((t = R[v][h].elm),
								t != y &&
									((C = e.grep(t.childNodes)),
									r(C, function (e) {
										y.appendChild(e);
									}),
									C.length &&
										((C = e.grep(y.childNodes)),
										(x = 0),
										r(C, function (e) {
											"BR" == e.nodeName &&
												H.getAttrib(e, "data-mce-bogus") &&
												x++ < C.length - 1 &&
												y.removeChild(e);
										})),
									H.remove(t)));
			...
			function y(e) {
				...
				for (
					r(R, function (n, i) {
						return (
							r(n, function (n) {
								return d(n) &&
									((n = n.elm), (l = n.parentNode), (u = s(l, !1)), (t = i), e)
									? !1
									: void 0;
							}),
							e ? !t : void 0
					...
					if (R[t][a] && ((i = R[t][a].elm), i != o)) {
						if (e) {
							if (
								t > 0 &&
								R[t - 1][a] &&
								((m = R[t - 1][a].elm), (h = n(m, "rowSpan")), h > 1)
							) {
								c(m, "rowSpan", h + 1);
								continue;
							}
				...
				u.hasChildNodes() &&
					(e ? l.parentNode.insertBefore(u, l) : H.insertAfter(u, l));
			}
			function b(e) {
				var t, i;
				r(R, function (n) {
					...
					r(R, function (r, o) {
						...
						r[t] &&
							...
							a != i &&
								...
								1 == l
									? e
										? (a.parentNode.insertBefore(p(a), a), h(t, o, s - 1, l))
										: (H.insertAfter(p(a), a), h(t, o, s - 1, l))
					...
					(t = H.getNext(e, "tr")),
						...
						r(R[i.y], function (e) {
							...
							(e = e.elm),
								e != o &&
									((t = n(e, "rowSpan")),
									1 >= t ? H.remove(e) : c(e, "rowSpan", t - 1),
									(o = e));
						});
				}
				var t;
				(t = u()),
					r(t.reverse(), function (t) {
						e(t);
					}),
					m();
			}
			...
			function N(e, t) {
				...
				e &&
					...
					H.removeClass(
						H.select("td.mce-item-selected,th.mce-item-selected"),
						"mce-item-selected"
					));
			}
			function S(e) {
			...
			function T(e) {
				...
				if (((B = S(e)), A && B)) {
					for (
						...
						(e = R[d][t]),
							e.real || (t - (e.colspan - 1) < t && (t -= e.colspan - 1));
					for (c = t; o >= c; c++)
						(e = R[n][c]),
							e.real || (n - (e.rowspan - 1) < n && (n -= e.rowspan - 1));
					for (d = n; i >= d; d++)
						for (c = t; r >= c; c++)
							(e = R[d][c]),
								e.real &&
			...
			var R,
				...
				M = i.selection,
				H = M.dom;
			(o = o || H.getParent(M.getStart(), "table")),
				a(),
				(P = H.getParent(M.getStart(), "th,td")),
				P && ((A = S(P)), (B = k()), (P = l(A.x, A.y))),
				e.extend(this, {
					deleteTable: f,
					split: g,
					merge: v,
				...
				function a() {
					...
					n.on("KeyDown", function (t) {
						...
						(37 == t.keyCode || 38 == t.keyCode) &&
							...
							(i = o.getParent(r.startContainer, "table")),
							i &&
								n.getBody().firstChild == i &&
								e(r, i) &&
								((r = o.createRng()),
								r.setStartBefore(i),
								r.setEndBefore(i),
						...
						e &&
							...
							(n.settings.forced_root_block
								? n.dom.add(
										...
										n.settings.forced_root_block,
										null,
										t.ie ? "&nbsp;" : '<br data-mce-bogus="1" />'
								  )
								: n.dom.add(n.getBody(), "br", { "data-mce-bogus": "1" }));
					}),
							...
							t &&
								("BR" == t.nodeName ||
									(1 == t.childNodes.length &&
										("BR" == t.firstChild.nodeName ||
											"\xa0" == t.firstChild.nodeValue))) &&
								t.previousSibling &&
								"TABLE" == t.previousSibling.nodeName &&
								n.dom.remove(t);
						});
				}
				function l() {
			...
			return function (r) {
				function i() {
					(r.getBody().style.webkitUserSelect = ""),
						c &&
							(r.dom.removeClass(
								r.dom.select("td.mce-item-selected,th.mce-item-selected"),
								"mce-item-selected"
							),
							(c = !1));
				}
				...
				return (
					r.on("MouseDown", function (e) {
						2 != e.button &&
							(i(),
							(s = o.getParent(e.target, "td,th")),
							(l = o.getParent(s, "table")));
					}),
					...
					r.on("MouseUp", function () {
						...
						if (s) {
							if (
								(a && (r.getBody().style.webkitUserSelect = ""),
								(d = o.select("td.mce-item-selected,th.mce-item-selected")),
								d.length > 0)
							) {
								(i = o.createRng()),
									(f = d[0]),
									...
									i.setEndAfter(f),
									e(f, 1),
									(u = new t(f, o.getParent(d[0], "table")));
								do
			...
			function s(r) {
				...
				function c() {
					var e = r.dom,
						...
						n,
						c;
					(t = r.dom.getParent(r.selection.getStart(), "table")),
						(c = !1),
						(n = {
						...
						r.windowManager.open({
							...
							items: {
								...
								items: [
									c ? { label: "Cols", name: "cols", disabled: !0 } : null,
									c ? { label: "Rows", name: "rows", disabled: !0 } : null,
							...
							onsubmit: function () {
								...
								r.undoManager.transact(function () {
									r.dom.setAttribs(t, {
										...
										(i = e.select("caption", t)[0]),
										i && !n.caption && e.remove(i),
										!i &&
											n.caption &&
											((i = e.create("caption")),
											o.ie || (i.innerHTML = '<br data-mce-bogus="1"/>'),
											t.insertBefore(i, t.firstChild)),
										s(t),
										n.align && r.formatter.apply("align" + n.align, {}, t),
										r.focus(),
										r.addVisual();
								});
							},
				...
				function u() {
					var e = r.dom,
						...
						n,
						o = [];
					(o = r.dom.select("td.mce-item-selected,th.mce-item-selected")),
						(t = r.dom.getParent(r.selection.getStart(), "td,th")),
						!o.length && t && o.push(t),
						(t = t || o[0]),
						(n = {
							width: i(e.getStyle(t, "width") || e.getAttrib(t, "width")),
						...
						r.windowManager.open({
							...
							onsubmit: function () {
								...
								r.undoManager.transact(function () {
									l(o, function (n) {
										r.dom.setAttrib(n, "scope", t.scope),
											r.dom.setStyles(n, { width: a(t.width), height: a(t.height) }),
											t.type &&
												n.nodeName.toLowerCase() != t.type &&
												(n = e.rename(n, t.type)),
											s(n),
				...
				function f() {
					var e = r.dom,
						...
						d = [];
					(t = r.dom.getParent(r.selection.getStart(), "table")),
						(n = r.dom.getParent(r.selection.getStart(), "td,th")),
						l(t.rows, function (t) {
							l(t.cells, function (r) {
								return e.hasClass(r, "mce-item-selected") || r == n
									? (d.push(t), !1)
									: void 0;
							});
						}),
						...
						r.windowManager.open({
							...
							onsubmit: function () {
								...
								r.undoManager.transact(function () {
									var c = t.type;
									l(d, function (l) {
										r.dom.setAttrib(l, "scope", t.scope),
											r.dom.setStyles(l, { height: a(t.height) }),
											c != l.parentNode.nodeName.toLowerCase() &&
												((n = e.getParent(l, "table")),
												(i = l.parentNode),
												(o = e.select(c, n)[0]),
												o ||
													((o = e.create(c)),
											...
											s(l),
											t.align && r.formatter.apply("align" + t.align, {}, l);
									}),
										r.focus();
								});
							},
				...
				function h(e, t) {
					function n() {
						e.disabled(!r.dom.getParent(r.selection.getStart(), t)),
							r.selection.selectorChanged(t, function (t) {
								e.disabled(!t);
							});
					}
				...
				function y() {
					...
					return (
						(e += "</table>"), (e += '<div class="mce-text-center">0 x 0</div>')
					);
				}
				var b,
					C,
				...
				r.addMenuItem("inserttable", {
					...
					onhide: function () {
						r.dom.removeClass(
							this.menu.items()[0].getEl().getElementsByTagName("a"),
							"mce-active"
						);
					},
					menu: [
						{
							...
							onmousemove: function (e) {
								var t = e.target;
								if ("A" == t.nodeName) {
									var n = r.dom.getParent(t, "table"),
										i = t.getAttribute("data-mce-index");
									if (i != this.lastPos) {
										(i = i.split(",")),
											(i[0] = parseInt(i[0], 10)),
											(i[1] = parseInt(i[1], 10));
										for (var o = 0; 10 > o; o++)
											for (var a = 0; 10 > a; a++)
												r.dom.toggleClass(
													n.rows[o].childNodes[a].firstChild,
													"mce-active",
													a <= i[0] && o <= i[1]
												);
										(n.nextSibling.innerHTML = i[0] + 1 + " x " + (i[1] + 1)),
											(this.lastPos = i);
									}
								}
							},
							onclick: function (e) {
								"A" == e.target.nodeName &&
									this.lastPos &&
									(e.preventDefault(),
									m(this.lastPos[0] + 1, this.lastPos[1] + 1),
									this.parent().cancel());
							},
						},
					],
					...
					r.addMenuItem("row", {
						...
						menu: [
							...
							{ text: "-" },
							{ text: "Cut row", onclick: p("mceTableCutRow"), onPostRender: v },
							{ text: "Copy row", onclick: p("mceTableCopyRow"), onPostRender: v },
							{
				...
				l(
					...
					r.addButton("table", { type: "menubutton", title: "Table", menu: w }),
					o.isIE ||
						r.on("click", function (e) {
							(e = e.target),
								"TABLE" === e.nodeName && (r.selection.select(e), r.nodeChanged());
						}),
					(x.quirks = new t(r)),
					r.on("Init", function () {
					...
					l(
						{
							...
							mceTableMergeCells: function (e) {
								var t, n, i;
								(i = r.dom.getParent(r.selection.getStart(), "th,td")),
									i && ((t = i.rowSpan), (n = i.colSpan)),
									r.dom.select("td.mce-item-selected,th.mce-item-selected").length
										? e.merge()
										: d(e, i);
							},
