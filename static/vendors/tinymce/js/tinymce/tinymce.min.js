...
!(function (e, t) {
	...
	var s = {},
		...
		u = "tinymce/dom/EventUtils",
		d = "tinymce/dom/TreeWalker",
		...
		E = "tinymce/dom/TridentSelection",
		S = "tinymce/util/VK",
		...
		ut = "tinymce/util/JSONRequest",
		dt = "tinymce/util/JSONP",
	...
	r(l, [], function () {
					...
					parse: function (t) {
						...
						if (t) {
							for (
								...
								(g = h[1].replace(a, "").toLowerCase()),
									(v = h[2].replace(a, "")),
									g &&
										v.length > 0 &&
										("font-weight" === g && "700" === v
											? (v = "bold")
											: ("color" === g || "background-color" === g) &&
											  (v = v.toLowerCase()),
										(v = v.replace(r, n)),
										(v = v.replace(i, p)),
										(m[g] = y ? f(v, !0) : v)),
		...
		r(u, [], function () {
				...
				return i.domLoaded
					...
					: (l.addEventListener
							...
							: (e(l, "readystatechange", a),
							  l.documentElement.doScroll && n === n.top && s()),
					  e(n, "load", o),
					  void 0);
			}
			function i() {
										...
										: (d ||
												...
												C &&
													(x = function (e) {
														var t, r;
														if (
															((t = e.currentTarget), (r = e.relatedTarget), r && t.contains)
														)
															r = t.contains(r);
										  ...
										  v
												? "ready" === b && a.domLoaded
													? p({ type: b })
													: v.push({ func: p, scope: m })
												: ((s[g][b] = v = [{ func: p, scope: m }]),
												  (v.fakeName = C),
												  (v.capture = w),
												  (v.nativeHandler = x),
							...
							if (((f = s[i]), n)) {
								for (n = n.split(" "), l = n.length; l--; )
									if (((d = n[l]), (o = f[d]))) {
										...
										(r && 0 !== o.length) ||
											(delete f[d], t(e, o.fakeName || d, o.nativeHandler, o.capture));
									}
							} else {
								for (d in f)
			...
			var o = "mce-data-",
				...
				s = { keyLocation: 1, layerX: 1, layerY: 1 };
		...
		r(f, [], function () {
			...
			function s(e, t, n) {
				...
				if (
					...
					if ("static" == e[2])
						return (
							(o[a] = t), this.onCreate && this.onCreate(e[2], e[3], o[a]), void 0
						);
		...
		r(p, [f], function (e) {
			function t(n) {
				...
				function u(e) {
					e ? ((D[U] = D[V]), (D[q] = D[z])) : ((D[V] = D[U]), (D[z] = D[q])),
						(D.collapsed = F);
				}
				function d(e) {
					a(e), c(e);
				...
				function _(e, t, r) {
					var i, o;
					for (
						e ? ((D[V] = t), (D[z] = r)) : ((D[U] = t), (D[q] = r)), i = D[U];
						i.parentNode;

					)
						i = i.parentNode;
					for (o = D[V]; o.parentNode; ) o = o.parentNode;
					o == i ? w(D[V], D[z], D[U], D[q]) > 0 && D.collapse(e) : D.collapse(e),
						(D.collapsed = x()),
				...
				function B(e, t, r, i) {
					...
					if (3 == e.nodeType) {
						if (
							((o = e.nodeValue),
							r
								? ((l = D[z]), (a = o.substring(l)), (s = o.substring(0, l)))
								: ((l = D[q]), (a = o.substring(0, l)), (s = o.substring(l))),
							i != O && (e.nodeValue = s),
							i == I)
						)
							return;
				...
				function H(e, t) {
					return t != I
						? t == O
							? n.clone(e, F)
							: e
						: (e.parentNode.removeChild(e), void 0);
				}
				function M() {
			...
			var f = {
				...
				decode: function (e) {
					return e.replace(u, function (e, n, r) {
						return n
							? ((r = parseInt(r, 2 === n.length ? 16 : 10)),
							  r > 65535
									? ((r -= 65536),
									  String.fromCharCode(55296 + (r >> 10), 56320 + (1023 & r)))
									: d[r] || String.fromCharCode(r))
							: a[e] || i[e] || t(e);
					});
				},
			};
		...
		r(g, [l, c, u, d, p, m, h, f], function (e, n, r, i, o, a, s, l) {
			function c(e, t) {
				...
				(i.doc = e),
					...
					(i.settings = t = m({ keep_values: !1, hex_colors: 1 }, t)),
					(i.schema = t.schema),
					(i.styles = new n(
						{
			...
			return (
				(c.prototype = {
					...
					getParents: function (e, n, r, i) {
						...
						for (
							e = o.get(e),
								i = i === t,
								r =
									r || ("BODY" != o.getRoot().nodeName ? o.getRoot().parentNode : null),
								d(n, "string") &&
									((a = n),
									(n =
										"*" === n
					...
					is: function (n, r) {
						...
						return n.nodeType && 1 != n.nodeType
							? !1
							: e.matches(r, n.nodeType ? [n] : n).length > 0;
					},
					add: function (e, t, n, r, i) {
						...
						return this.run(e, function (e) {
							var a;
							return (
								(a = d(t, "string") ? o.doc.createElement(t) : t),
								o.setAttribs(a, n),
							...
							if (t)
								if ("string" == typeof t) {
									(i = e.style),
										...
										"opacity" === t &&
											e.runtimeStyle &&
											"undefined" == typeof e.runtimeStyle.opacity &&
											(i.filter = "" === n ? "" : "alpha(opacity=" + 100 * n + ")"),
										"float" == t &&
					...
					getAttrib: function (e, t, n) {
						...
						if (
							(d(n) || (n = ""),
							/^(src|href|style|coords|shape)$/.test(t) &&
						...
						if (
							(g &&
								i.props[t] &&
								((r = e[i.props[t]]), (r = r && r.nodeValue ? r.nodeValue : r)),
					...
					loadCSS: function (e) {
						var t = this,
							n = t.doc,
							r;
						return t !== c.DOM && n === document
							? (c.DOM.loadCSS(e), void 0)
							: (e || (e = ""),
							  (r = n.getElementsByTagName("head")[0]),
					...
					removeClass: function (e, t) {
						...
						return n.run(e, function (e) {
							var i;
							return n.hasClass(e, t)
								? (r || (r = new RegExp("(^|\\s+)" + t + "(\\s+|$)", "g")),
								  (i = e.className.replace(r, " ")),
								  (i = p(" " != i ? i : "")),
								  (e.className = i),
								  i || (e.removeAttribute("class"), e.removeAttribute("className")),
								  i)
								: e.className;
						});
					},
					...
					toggleClass: function (e, n, r) {
						(r = r === t ? !this.hasClass(e, n) : r),
							this.hasClass(e, n) !== r &&
								(r ? this.addClass(e, n) : this.removeClass(e, n));
					},
					show: function (e) {
					...
					replace: function (e, t, n) {
						...
						return r.run(t, function (t) {
							return (
								d(t, "array") && (e = e.cloneNode(!0)),
								n &&
									u(f(t.childNodes), function (t) {
										e.appendChild(t);
									}),
								...
								? ((n = n || this),
								  e.nodeType || (!e.length && 0 !== e.length)
										...
										: ((i = []),
										  u(e, function (e, o) {
												e &&
													("string" == typeof e && (e = r.get(e)), i.push(t.call(n, e, o)));
										  }),
										  i))
								: !1
						);
					...
					nodeIndex: function (e, t) {
						...
						if (e)
							for (
								r = e.nodeType, e = e.previousSibling, i = e;
								e;
								e = e.previousSibling
							)
								(o = e.nodeType),
				...
				(this.isDone = function (e) {
					...
					(this.add = this.load =
						function (e, n, r) {
							var i = s[e];
							i == f && (l.push(e), (s[e] = t)),
								n && (c[e] || (c[e] = []), c[e].push({ func: n, scope: r || this }));
						}),
				...
				(r.prototype = {
					...
					requireLangPack: function (t) {
						...
						n &&
							n.language &&
							n.language_load !== !1 &&
							e.ScriptLoader.add(this.urls[t] + "/langs/" + n.language + ".js");
					},
					add: function (e, t, n) {
						return (
							this.items.push(t),
		...
		r(C, [f], function (e) {
			...
			function n(e) {
				function n(e, n, r) {
					...
					var o,
						...
						u = arguments;
					for (
						r = r || [], n = n || "", "string" == typeof r && (r = t(r)), l = 3;
						l < u.length;
						l++
					)
					...
					for (e = t(e), o = e.length; o--; )
						(c = [].concat(s, t(n))),
							(a[e[o]] = { attributes: i(c), attributesOrder: c, children: i(r) });
				}
				function i(e, n) {
					var r, i, o, s;
				...
				return r[e]
					? r[e]
					: ((s = t("id accesskey class dir lang style tabindex title")),
					  (l = t(
					  ...
					  "html5-strict" != e &&
							...
							i(
								"object",
								"declare classid codebase codetype archive standby align border hspace vspace"
							),
					  ...
					  "html4" != e &&
							...
							i("iframe", "srcdoc sandbox seamless allowfullscreen")),
					  o(t("a form meter progress dfn"), function (e) {
			...
			return function (e) {
				function c(t, n, o) {
					...
					return (
						s
							? (s = i(s, ",", i(s.toUpperCase(), " ")))
							: ((s = r[t]),
							  s ||
									((s = i(n, " ", i(n.toUpperCase(), " "))), (s = a(s, o)), (r[t] = s))),
						s
					);
				}
				function u(e) {
				...
				function d(e) {
					...
					if (e)
						for (
							e = t(e, ","),
								v["@"] && ((w = v["@"].attributes), (_ = v["@"].attributesOrder)),
								n = 0,
								r = e.length;
							r > n;
							n++
							...
							if ((s = E.exec(e[n]))) {
								if (
									...
									(g = {}),
									(y = []),
									(c = { attributes: g, attributesOrder: y }),
									"#" === C && (c.paddEmpty = !0),
									"-" === C && (c.removeEmpty = !0),
									"!" === s[4] && (c.removeEmptyAttrs = !0),
									w)
								) {
									for (N in w) g[N] = w[N];
									y.push.apply(y, _);
										...
										if ((s = S.exec(f[o]))) {
											...
											C &&
												("=" === C &&
													...
													c.attributesDefault.push({ name: m, value: k }),
													(d.defaultValue = k)),
												":" === C &&
													((c.attributesForced = c.attributesForced || []),
													c.attributesForced.push({ name: m, value: k }),
													(d.forcedValue = k)),
												"<" === C && (d.validValues = i(k, "?"))),
												T.test(m)
													? ((c.attributePatterns = c.attributePatterns || []),
													  (d.pattern = u(m)),
													  c.attributePatterns.push(d))
													: (g[m] || y.push(m), (g[m] = d));
										}
								w || "@" != p || ((w = g), (_ = y)),
				...
				(e = e || {}),
					...
					(E = c(
						"block_elements",
						"hr table tbody thead tfoot th tr td li ol ul caption dl dt dd noscript menu isindex samp option datalist select optgroup",
						T
					)),
					o(
					...
					e.valid_elements
						...
						: (o(x, function (e, t) {
						  ...
						  "html5" != e.schema &&
								o(t("strong/b em/i"), function (e) {
									(e = t(e, "/")), (v[e[1]].outputName = e[0]);
								}),
						  (v.img.attributesDefault = [{ name: "alt", value: "" }]),
						  o(
								t("ol ul sub sup blockquote span font a table tbody tr strong em b i"),
								function (e) {
					...
					m("+ol[ul|ol],+ul[ul|ol]"),
					e.invalid_elements &&
						o(s(e.invalid_elements), function (e) {
							v[e] && delete v[e];
						}),
					h("span") || d("span[!data-mce-type|*]"),
					(g.children = y),
					(g.styles = C),
					...
					(o.parse = function (e) {
						...
						for (
							M = new RegExp(
								...
								D =
									/([\w:\-]+)(?:\s*=\s*(?:(?:\"((?:[^\"])*)\")|(?:\'((?:[^\'])*)\')|([^>\s]+)))?/g,
								y = i.getShortEndedElements(),
								H = n.self_closing_elements || i.getSelfClosingElements(),
								b = i.getBoolAttrs(),
								x = n.validate,
								v = n.remove_internals,
								F = n.fix_self_closing,
							...
							if ((l < s.index && a.text(I(e.substr(l, s.index - l))), (c = s[6])))
								...
								if (
									...
									(C = c in y),
									F && H[c] && d.length > 0 && d[d.length - 1].name === c && r(c),
									!x || (w = i.getElementRule(c)))
								) {
									if (
										((_ = !0),
										x && ((E = w.attributes), (S = w.attributePatterns)),
										(k = s[8])
											? ((g = -1 !== k.indexOf("data-mce-type")),
											  g && v && (_ = !1),
											  (f = []),
											  (f.map = {}),
											  k.replace(D, o))
										...
										if (
											...
											(R = w.attributesDefault),
											(A = w.attributesForced),
											(B = w.removeEmptyAttrs),
											B && !f.length && (_ = !1),
											A)
										)
											for (p = A.length; p--; )
								...
								if ((u = L[c])) {
									(u.lastIndex = l = s.index + s[0].length),
										(s = u.exec(e))
											? (_ && (m = e.substr(l, s.index - l)), (l = s.index + s[0].length))
											: ((m = e.substr(l)), (l = e.length)),
										_ && (m.length > 0 && a.text(m, !0), a.end(c)),
										(M.lastIndex = l);
									continue;
								}
								C ||
						...
						for (
							l < e.length && a.text(I(e.substr(l))), p = d.length - 1;
							p >= 0;
							p--
						)
		...
		r(w, [b, C, x, f], function (e, t, n, r) {
			...
			return function (r, l) {
				function c(t) {
					...
					for (
						h = i("tr,td,th,tbody,thead,tfoot,table"),
						...
						if (((r = t[n]), r.parent && !r.fixed))
							if (g[r.name] && "li" == r.parent.name) {
								...
								for (
									a = [r], o = r.parent;
									o && !l.isValidChild(o.name, r.name) && !h[o.name];
									o = o.parent
								)
									a.push(o);
								if (o && a.length > 1) {
				...
				(r = r || {}),
					...
					(u.parse = function (t, o) {
						function a() {
							function e(e) {
								e &&
									...
									(t = e.lastChild),
									t && 3 == t.type && (t.value = t.value.replace(H, "")));
							}
							var t = y.firstChild,
								n,
								r;
								...
								for (; t; )
									(n = t.next),
										...
										(1 == t.type &&
											...
											? r
												? r.append(t)
												: ((r = u(I, 1)), y.insert(r, t), r.append(t))
											: (e(r), (r = null)),
										(t = n);
								e(r);
							}
						...
						if (
							...
							(S = r.validate),
							(I =
								"forced_root_block" in o ? o.forced_root_block : r.forced_root_block),
									...
									start: function (e, t, n) {
										...
										if ((o = S ? l.getElementRule(e) : {})) {
											for (
												...
												(a = f[i].name),
													a in t.map && ((k = m[a]), k ? k.push(r) : (m[a] = [r]));
							...
							for (E in p) {
								...
								for (x = 0, w = k.length; w > x; x++) k[x](C, E, o);
							}
							for (x = 0, w = f.length; w > x; x++)
								if (((k = f[x]), k.name in m)) {
									for (C = m[k.name], _ = C.length; _--; ) C[_].parent || C.splice(_, 1);
					...
					r.remove_trailing_brs &&
						u.addNodeFilter("br", function (t) {
							...
							for (o.body = 1, n = 0; r > n; n++)
								if (
									((i = t[n]), (c = i.parent), o[i.parent.name] && i === c.lastChild)
								) {
									for (d = i.prev; d; ) {
										if (
											((f = d.name),
										...
										c.isEmpty(a) &&
											...
											p &&
												(p.removeEmpty
													? c.remove()
													: p.paddEmpty &&
													  (c.empty().append(new e("#text", 3)).value = "\xa0"))));
								} else {
									for (
										u = i;
								...
								if (
									...
									for (
										f = [],
											...
											p = 0,
											m = h.attributesOrder.length;
										m > p;
										p++
									)
										(u = h.attributesOrder[p]),
											u in c.map &&
												((d = c.map[u]), (f.map[u] = d), f.push({ name: u, value: d }));
			...
			return function (e, i) {
				...
				return (
					...
					f.addAttributeFilter(
						"data-mce-src,data-mce-href,data-mce-style,data-mce-selected",
						function (e, t) {
							for (var n = e.length; n--; ) e[n].attr(t, null);
						}
					),
						...
						serialize: function (t, n) {
							...
							return (
								a.ie && s.select("script,style,select,map").length > 0
									? ((h = t.innerHTML), (t = t.cloneNode(!1)), s.setHTML(t, h))
									: (t = t.cloneNode(!0)),
			...
			function e(e) {
				...
				function n() {
					...
					var o = e.getRng(),
						...
						d;
					if (
						((s = o.item ? o.item(0) : o.parentElement()), s.ownerDocument != i.doc)
					)
						return a;
							...
							(a = i.create("a")),
								...
								3 == t.nodeType
									...
									: ((m = t.childNodes),
									  m.length
											? (n >= m.length
													? i.insertAfter(a, m[m.length - 1])
													: t.insertBefore(a, m[n]),
											  d.moveToElementText(a))
											: t.canHaveHTML &&
		...
		r(T, [S, f, h], function (e, t, n) {
			return function (r, i) {
				function o(e) {
					return i.settings.object_resizing === !1
						? !1
						: /TABLE|IMG|DIV/.test(e.nodeName)
				...
				function a(t) {
					...
					(n = t.screenX - E),
						...
						(D = 5 > D ? 5 : D),
						(L = 5 > L ? 5 : L),
						(e.modifierPressed(t) || ("IMG" == x.nodeName && 0 !== N[2] * N[3])) &&
							((D = Math.round(L / H)), (L = Math.round(D * H))),
						b.setStyles(w, { width: D, height: L }),
						N[2] < 0 && w.clientWidth <= D && b.setStyle(w, "left", T + (A - D)),
						N[3] < 0 && w.clientHeight <= L && b.setStyle(w, "top", R + (B - L)),
						M ||
							(i.fire("ObjectResizeStart", { target: x, width: A, height: B }),
							(M = !0));
				}
				function s() {
					function e(e, t) {
						t &&
							(x.style[e] || !i.schema.isValid(x.nodeName.toLowerCase(), e)
								? b.setStyle(x, e, t)
								: b.setAttrib(x, e, t));
					}
					(M = !1),
						...
						i.fire("ObjectResized", { target: x, width: D, height: L }),
						i.nodeChanged();
				}
				function l(e, t, n) {
					var r,
						...
						d,
						f,
						p = i.getBody().offsetParent || i.getBody();
					(r = b.getPos(e, p)),
						(T = r.x),
						(R = r.y),
						...
						x != e && (h(), (x = e), (D = L = 0)),
						(d = i.fire("ObjectSelected", { target: e })),
						o(e) && !d.isDefaultPrevented()
							? C(_, function (e, r) {
									function o(t) {
										(M = !0),
											(E = t.screenX),
											...
											(w.contentEditable = !1),
											(w.unSelectabe = !0),
											b.setStyles(w, { left: T, top: R, margin: 0 }),
				...
				function u(e) {
					...
					var n;
					return (
						C(b.select("img[data-mce-selected],hr[data-mce-selected]"), function (e) {
						...
						t(r.getStart(), n) &&
							t(r.getEnd(), n) &&
							(!I || (n != r.getStart() && "IMG" !== r.getStart().nodeName)))
							? (l(n), void 0)
							: (c(), void 0)
					);
				}
					...
					i.on("init", function () {
						I
							? (i.on("ObjectResized", function (e) {
							  ...
							  d(i.getBody(), "controlselect", m),
							  i.on("mousedown", function (e) {
									k = e;
							  }))
							: (g(),
							  n.ie >= 11 &&
									i.on("mouseup mousedown", function (e) {
										("IMG" == e.target.nodeName ||
											"IMG" == i.selection.getNode().nodeName) &&
											(e.preventDefault(), i.selection.select(e.target));
									})),
							i.on("nodechange mousedown ResizeEditor", u),
				...
				(a.prototype = {
						...
						return t.duplicate || t.item
							? t.item
								...
								: ((t = t.duplicate()),
								  ...
								  (n = t.parentElement()),
								  n.ownerDocument !== e.dom.doc && (n = e.dom.getRoot()),
								  n && "BODY" == n.nodeName ? n.lastChild || n : n)
							: ((n = t.endContainer),
							  (r = t.endOffset),
							  1 == n.nodeType &&
									n.hasChildNodes() &&
							...
							(c = r(l.cloneRange())),
								d ||
									...
									c.insertNode(
										a.create(
											"span",
											{ "data-mce-type": "bookmark", id: u + "_end", style: h },
											m
										)
									)),
								(l = r(l)),
								...
								l.insertNode(
									a.create(
										"span",
										{ "data-mce-type": "bookmark", id: u + "_start", style: h },
										m
									)
								);
						}
					...
					moveToBookmark: function (e) {
						...
						function n(t) {
							...
							if (
								...
								((r = n.parentNode),
								"start" == t
									? (u ? ((r = n.firstChild), (i = 1)) : (i = o.nodeIndex(n)),
									  (f = p = r),
									  (m = h = i))
									: (u ? ((r = n.firstChild), (i = 1)) : (i = o.nodeIndex(n)),
									  (p = r),
								...
								c &&
									...
									3 == c.nodeType &&
									!d &&
									((i = c.nodeValue.length),
									c.appendData(a.nodeValue),
									o.remove(a),
									"start" == t ? ((f = p = c), (m = h = i)) : ((p = c), (h = i)));
							}
						}
						function r(e) {
							return (
								...
								e.id
									? (n("start"),
									  ...
									  f &&
											...
											i.setRng(a)))
									: e.name
									? i.select(o.select(e.name)[e.index])
									: e.rng && i.setRng(e.rng);
					},
					select: function (t, n) {
						function r(t, n) {
							var r = new e(t, t);
					...
					getRng: function (e) {
						...
						return (
							...
							r.setStart &&
								9 === r.startContainer.nodeType &&
								r.collapsed &&
								((i = t.dom.getRoot()), r.setStart(i, 0), r.setEnd(i, 0)),
							t.selectedRange &&
								t.explicitRange &&
								(0 === r.compareBoundaryPoints(r.START_TO_START, t.selectedRange) &&
								0 === r.compareBoundaryPoints(r.END_TO_END, t.selectedRange)
									? (r = t.explicitRange)
									: ((t.selectedRange = null), (t.explicitRange = null))),
							r
						);
					},
					setRng: function (e, t) {
					...
					normalize: function () {
						function t(t) {
							function a(t, n) {
								for (
									var r = new e(t, f.getParent(t.parentNode, f.isBlock) || p);
									(t = r[n ? "prev" : "next"]());
							...
							function l(t, n) {
								var r, a;
								for (
									n = n || c, r = new e(n, f.getParent(n.parentNode, f.isBlock) || p);
									(m = r[t ? "prev" : "next"]());
							...
							var c,
								...
								g;
							if (
								((c = r[(t ? "start" : "end") + "Container"]),
								(u = r[(t ? "start" : "end") + "Offset"]),
								(h = f.schema.getNonEmptyElements()),
								9 === c.nodeType && ((c = f.getRoot()), (u = 0)),
								c === p)
							) {
								if (
									t &&
									((m = c.childNodes[u > 0 ? u - 1 : 0]),
									m &&
										((g = m.nodeName.toLowerCase()),
										h[m.nodeName] || "TABLE" == m.nodeName))
								)
									return;
								if (
									c.hasChildNodes() &&
									((u = Math.min(!t && u > 0 ? u - 1 : u, c.childNodes.length - 1)),
									(c = c.childNodes[u]),
									(u = 0),
						...
						u ||
							...
							t(!0),
							o || t(),
							i && (o && r.collapse(!0), n.setRng(r, n.isForward())));
					},
					...
					scrollIntoView: function (e) {
						...
						(n = i.getViewPort(r.editor.getWin())),
							(t = i.getPos(e).y),
							(t < n.y || t + 25 > n.y + n.h) &&
								r.editor.getWin().scrollTo(0, t < n.y ? t : t - n.h + 25);
					},
					destroy: function () {
		...
		r(A, [f], function (e) {
			function t(e) {
				(this.walk = function (t, r) {
					...
					var l = t.startContainer,
						...
						y;
					if (
						((y = e.select("td.mce-item-selected,th.mce-item-selected")),
						y.length > 0)
					)
						return (
							n(y, function (e) {
					...
					if (
						(1 == l.nodeType && l.hasChildNodes() && (l = l.childNodes[c]),
						1 == u.nodeType &&
							u.hasChildNodes() &&
							(u = u.childNodes[Math.min(d - 1, u.childNodes.length - 1)]),
						l == u)
					)
						return r(i([l]));
			...
			var n = e.each;
			return (
				(t.compareRanges = function (e, t) {
					if (e && t) {
						if (!e.item && !e.duplicate)
							return (
								e.startContainer == t.startContainer && e.startOffset == t.startOffset
							);
			...
			return function (r) {
				...
				function f(e) {
					...
					1 === e.nodeType &&
						...
						((t = d(e.parentNode)),
						r.dom.getStyle(e, "color") && t
							? r.dom.setStyle(e, "text-decoration", t)
							: r.dom.getStyle(e, "textdecoration") === t &&
				...
				function p(t, n, o) {
					function s(e, t) {
						(t = t || h),
							e &&
								(t.onformat && t.onformat(e, t, n, o),
								et(t.styles, function (t, r) {
					...
					function u(e, t, n, r, i) {
						...
						return (
							et(e.childNodes, function (e, t) {
								return "UL" === e.nodeName || "OL" === e.nodeName
									? ((a = t), (s = e), !1)
									: void 0;
							}),
							et(e.childNodes, function (e, n) {
								"SPAN" === e.nodeName &&
									"bookmark" == I.getAttrib(e, "data-mce-type") &&
									(e.id == t.id + "_start" ? (l = n) : e.id == t.id + "_end" && (c = n));
							}),
							0 >= a || (a > l && c > a)
								? (et(tt(e.childNodes), i), 0)
								: ((u = I.clone(n, K)),
								  et(tt(e.childNodes), function (e, t) {
										((a > l && a > t) || (l > a && t > a)) &&
											(o.push(e), e.parentNode.removeChild(e));
								  }),
								  a > l
										? e.insertBefore(u, s)
										: l > a && e.insertBefore(u, s.nextSibling),
								  r.push(u),
								  et(o, function (e) {
										u.appendChild(e);
								  }),
								...
								function p(e) {
									...
									return (
										...
										1 === e.nodeType &&
											...
											((N = f), (f = "true" === J(e)), (_ = !0)),
										w(y, "br")
											? ((v = 0), h.block && I.remove(e), void 0)
											: h.wrapper && g(e, t, n)
											? ((v = 0), void 0)
											: f && !_ && h.block && !h.wrapper && i(y) && z(C, c)
											? ((e = I.rename(e, c)), s(e), l.push(e), (v = 0), void 0)
											: h.selector &&
											  (et(m, function (t) {
													("collapsed" in t && t.collapsed !== b) ||
														(I.is(e, t.selector) && !a(e) && (s(e, t), (x = !0)));
											  }),
											  !h.inline || x)
											? ((v = 0), void 0)
											: (!f ||
											  ...
											  (h.inline && V(e))
													? "li" == y && r
														? (v = u(e, r, d, l, p))
														: ((v = 0), et(tt(e.childNodes), p), _ && (f = N), (v = 0))
													: (v ||
															((v = I.clone(d, K)),
							...
							h.wrap_links === !1 &&
								et(l, function (e) {
									function t(e) {
										...
										if ("A" === e.nodeName) {
											for (
												r = I.clone(d, K), l.push(r), i = tt(e.childNodes), n = 0;
												n < i.length;
												n++
											)
												r.appendChild(i[n]);
							...
							et(l, function (e) {
								...
								function i(e) {
									...
									return (
										...
										t &&
											x(t, h) &&
											((n = I.clone(t, K)), s(n), I.replace(n, e, G), I.remove(t, 1)),
										n || e
									);
								}
								var o;
								...
								if (h.inline || h.wrapper) {
									...
									h.merge_with_parents &&
										I.getParent(e.parentNode, function (r) {
											return g(r, t, n) ? (I.remove(e, 1), (e = 0), G) : void 0;
										}),
										e &&
											h.merge_siblings !== !1 &&
											((e = M(B(e), e)), (e = M(e, B(e, G))));
								}
							});
					}
					var m = c(t),
					...
					if (h)
						if (o)
							...
							b &&
							h.inline &&
							!I.select("td.mce-item-selected,th.mce-item-selected").length
						)
							L("apply", t, n);
						else {
							...
							U ||
								!m[0].defaultBlock ||
								I.getParent(C, I.isBlock) ||
								p(m[0].defaultBlock),
								r.selection.setRng(l()),
								(v = F.getBookmark()),
								d(T(F.getRng(G), m), v),
								h.styles &&
									(h.styles.color || h.styles.textDecoration) &&
									(nt(C, f, "childNodes"), f(C)),
								F.moveToBookmark(v),
								P(F.getRng(G)),
								r.nodeChanged();
						}
				...
				function m(e, t, n) {
					function i(e) {
						var n, r, o, a, s;
						if (
							(1 === e.nodeType && J(e) && ((a = b), (b = "true" === J(e)), (s = !0)),
							(n = tt(e.childNodes)),
							b && !s)
						)
					...
					function a(n) {
						var r;
						return (
							et(o(n.parentNode).reverse(), function (n) {
								var i;
								r ||
									"_start" == n.id ||
									"_end" == n.id ||
									((i = g(n, e, t)), i && i.split !== !1 && (r = n));
							}),
							r
						);
					}
					...
					function u(e) {
						...
						return (
							H(n) && (n = n[e ? "firstChild" : "lastChild"]), I.remove(t, !0), n
						);
					}
					function f(e) {
						var t, n;
						(e = T(e, p, G)),
							m.split &&
								...
								(n = D(e)),
								t != n
									? (/^(TR|TD)$/.test(t.nodeName) &&
											t.firstChild &&
											(t =
												"TD" == t.nodeName
													? t.firstChild || t
													: t.firstChild.firstChild || t),
									  (t = S(t, "span", { id: "_start", "data-mce-type": "bookmark" })),
									  (n = S(n, "span", { id: "_end", "data-mce-type": "bookmark" })),
									  l(t),
									  l(n),
									  (t = u(G)),
									  (n = u()))
							...
							W.walk(e, function (e) {
								et(e, function (e) {
									i(e),
										1 === e.nodeType &&
											"underline" === r.dom.getStyle(e, "text-decoration") &&
											e.parentNode &&
											"underline" === d(e.parentNode) &&
											R(
												{
													deep: !1,
													exact: !0,
					...
					return n
						? (n.nodeType
								? ((y = I.createRng()), y.setStartBefore(n), y.setEndAfter(n), f(y))
								: f(n),
						  void 0)
						: (F.isCollapsed() &&
						  m.inline &&
						  !I.select("td.mce-item-selected,th.mce-item-selected").length
								...
								: ((h = F.getBookmark()),
								  f(F.getRng(G)),
								  F.moveToBookmark(h),
								  m.inline && v(e, t, F.getStart()) && P(F.getRng(!0)),
								  r.nodeChanged()),
						  void 0);
				}
				function h(e, t, n) {
					var r = c(e);
					!v(e, t, n) || ("toggle" in r[0] && !r[0].toggle)
						? p(e, t, n)
						: m(e, t, n);
				}
				function g(e, t, n, r) {
							...
							if (s.length === X) {
								for (o in s)
									if (s.hasOwnProperty(o)) {
										if (
											((a = "attributes" === i ? I.getAttrib(e, o) : _(e, o)),
											r && !a && !t.exact)
										)
											return;
										if ((!r || t.exact) && !w(a, N(k(s[o], n), o))) return;
									}
							} else
					...
					if (o && e)
						for (s = 0; s < o.length; s++)
							if (
								((a = o[s]), x(e, a) && i(e, a, "attributes") && i(e, a, "styles"))
							) {
								if ((l = a.classes))
									for (s = 0; s < l.length; s++) if (!I.hasClass(e, l[s])) return;
								return a;
							}
				}
				function v(e, t, n) {
					...
					return n
						? r(n)
						: ((n = F.getNode()),
						  r(n) ? G : ((i = F.getStart()), i != n && r(i) ? G : K));
				}
				function y(e, t) {
					var n,
						r = [],
				...
				function x(e, t) {
					return w(e, t.inline)
						...
						? G
						: t.selector
						? 1 == e.nodeType && I.is(e, t.selector)
						: void 0;
				}
				function w(e, t) {
					return (
				...
				function N(e, t) {
					return (
						("color" == t || "backgroundColor" == t) && (e = I.toHex(e)),
				...
				function T(t, n, a) {
					function s(e) {
						function t(e) {
							return (
								"BR" == e.nodeName && e.getAttribute("data-mce-bogus") && !e.nextSibling
							);
						}
						var r, i, o, a, s;
						if (
							...
							(s = I.getRoot()),
							3 == r.nodeType && !E(r) && (e ? v > 0 : b < r.nodeValue.length))
						)
							return r;
						for (;;) {
							if (!n[0].block_expand && V(i)) return i;
							for (o = i[a]; o; o = o[a]) if (!H(o) && !E(o) && !t(o)) return i;
							if (i.parentNode == s) {
								r = i;
								break;
							}
					...
					function l(e, t) {
						for (
							t === X && (t = 3 === e.nodeType ? e.length : e.childNodes.length);
							e && e.hasChildNodes();
					...
					function u(t, n, i) {
						function o(e, t) {
							var n,
								...
								o = e.nodeValue;
							return (
								"undefined" == typeof t && (t = i ? o.length : 0),
								i
									? ((n = o.lastIndexOf(" ", t)),
									  (r = o.lastIndexOf("\xa0", t)),
									  (n = n > r ? n : r),
									  -1 === n || a || n++)
									: ((n = o.indexOf(" ", t)),
									  (r = o.indexOf("\xa0", t)),
						...
						for (
							s = new e(t, I.getParent(t, V) || r.getBody());
							(l = s[i ? "prev" : "next"]());
					...
					function d(e, r) {
						...
						for (
							...
							for (s = 0; s < n.length; s++)
								if (
									((l = n[s]),
									!("collapsed" in l && l.collapsed !== t.collapsed) &&
										I.is(i[a], l.selector))
								)
									return i[a];
						return e;
					...
					function f(e, t) {
						var r,
							a = I.getRoot();
						if (
							(n[0].wrapper || (r = I.getParent(e, n[0].block)),
							r ||
								(r = I.getParent(3 == e.nodeType ? e.parentNode : e, function (e) {
									return e != a && i(e);
								})),
					...
					if (
						...
						n[0].inline &&
							(t.collapsed &&
								((h = u(g, v, !0)),
								h && ((g = h.container), (v = h.offset)),
								(h = u(y, b)),
								h && ((y = h.container), (b = h.offset))),
							(m = l(y, b)),
							m.node))
					) {
						...
						m.node &&
							m.offset > 0 &&
							3 === m.node.nodeType &&
							" " === m.node.nodeValue.charAt(m.offset - 1) &&
							m.offset > 1 &&
							((y = m.node), y.splitText(m.offset - 1));
					}
					return (
						(n[0].inline || n[0].block_expand) &&
							((n[0].inline && 3 == g.nodeType && 0 !== v) || (g = s(!0)),
								...
								et(e.attributes, function (e, i) {
									...
									if (
										...
										"class" == i && n.removeAttribute("className"),
											$.test(i) && n.removeAttribute("data-mce-" + i),
											n.removeAttribute(i);
									}
								}),
				...
				function A(e, t) {
					...
					t.block &&
						(U
							? r == I.getRoot() &&
							  ((t.list_block && w(e, t.list_block)) ||
									et(tt(e.childNodes), function (e) {
										z(U, e.nodeName.toLowerCase())
											? i
												? i.appendChild(e)
												: (i = S(e, U))
											: (i = 0);
							...
							: V(e) &&
							  ...
							  n(e, G) || n(e.lastChild, K, 1) || e.appendChild(I.create("br")))),
						(t.selector && t.inline && !w(t.inline, e)) || I.remove(e, 1);
				}
				function B(e, t, n) {
					if (e)
						for (
							...
							if (1 == e.nodeType || !E(e)) return e;
				}
				function H(e) {
					return (
						e && 1 == e.nodeType && "bookmark" == e.getAttribute("data-mce-type")
					);
				}
				function M(e, t) {
					function n(e, t) {
						...
						return e.nodeName != t.nodeName
							...
							: r(n(e), n(t))
							? r(
									I.parseStyle(I.getAttrib(e, "style")),
									I.parseStyle(I.getAttrib(t, "style"))
							  )
								? G
								: K
							: K;
					...
					if (
						e &&
						t &&
						((e = r(e, "previousSibling")), (t = r(t, "nextSibling")), n(e, t))
					) {
						for (i = e.nextSibling; i && i != t; )
							(o = i), (i = i.nextSibling), e.appendChild(o);
						return (
							I.remove(t),
							et(tt(t.childNodes), function (t) {
								e.appendChild(t);
							}),
							e
						);
				...
				function L(t, n, o) {
					...
					function d(e, t) {
						...
						if (e)
							(r = F.getRng(!0)),
								s(e)
									? (t !== !1 && (r.setStartBefore(e), r.setEndBefore(e)), I.remove(e))
									: ((n = u(e)),
									  n.nodeValue.charAt(0) === j && (n = n.deleteData(0, 1)),
									  I.remove(e, 1)),
								F.setRng(r);
						else if (((e = l(F.getStart())), !e)) for (; (e = I.get(y)); ) d(e, !1);
					}
					function f() {
						var e, t, r, i, s, d, f;
						(e = F.getRng(!0)),
					...
					function h() {
						...
						for (
							t = e.startContainer,
								...
								u = t,
								3 == t.nodeType &&
									((r != t.nodeValue.length || t.nodeValue === j) && (l = !0),
									(u = u.parentNode));
							u;
								...
								nt(
									...
									function (e) {
										1 != e.nodeType ||
											e.id === y ||
											I.isEmpty(e) ||
											I.setAttrib(e, "data-mce-bogus", null);
									},
									"childNodes"
								);
					}
				...
				function P(t) {
					...
					if (
						(3 == n.nodeType &&
							r >= n.nodeValue.length &&
							((r = q(n)), (n = n.parentNode), (i = !0)),
						1 == n.nodeType)
					)
						for (
							s = n.childNodes,
								n = s[Math.min(r, s.length - 1)],
								o = new e(n, I.getParent(n, I.isBlock)),
					...
					return (
						...
						t.on("KeyUp", function (n) {
							...
							((r >= 33 && 36 >= r) ||
								...
								n.ctrlKey) &&
								(o(), t.nodeChanged()),
								(46 == r || 8 == r || (e.mac && (91 == r || 93 == r))) &&
									t.nodeChanged(),
								u &&
									a.typing &&
									(t.isDirty() ||
										((t.isNotDirty = !l[0] || i() == l[0].content),
										t.isNotDirty || t.fire("change", { level: l[0], lastLevel: null })),
									t.fire("TypingUndo"),
									(u = !1),
									t.nodeChanged());
						}),
						t.on("KeyDown", function (e) {
							var t = e.keyCode;
							return (t >= 33 && 36 >= t) || (t >= 37 && 40 >= t) || 45 == t
								? (a.typing && o(), void 0)
								: ((16 > t || t > 20) &&
										224 != t &&
										91 != t &&
										!a.typing &&
										(a.beforeChange(), (a.typing = !0), a.add(), (u = !0)),
								  void 0);
						}),
						...
						(a = {
							...
							add: function (e) {
								...
								if (
									((e = e || {}),
									(e.content = i()),
									d || t.fire("BeforeAddUndo", { level: e }).isDefaultPrevented())
								)
									return null;
								if (((o = l[s]), o && o.content == e.content)) return null;
								if (
									(l[s] && (l[s].beforeBookmark = c),
									r.custom_undo_redo_levels && l.length > r.custom_undo_redo_levels)
								) {
							...
							undo: function () {
								...
								return (
									...
									s > 0 &&
										((e = l[--s]),
										t.setContent(e.content, { format: "raw" }),
			...
			return function (t) {
				function r(r) {
					...
					function d(e) {
						...
						i.isBlock(e) &&
							((t = o.getRng()),
							e.appendChild(i.create("span", null, "\xa0")),
							o.select(e),
					...
					function m(e) {
						var t = E,
							...
							s;
						if (
							((r = e || "TABLE" == D ? i.create(e || P) : T.cloneNode(!1)),
							(s = r),
							a.keep_styles !== !1)
						)
							do
								if (/^(SPAN|STRONG|B|EM|I|FONT|STRIKE|U)$/.test(t.nodeName)) {
									...
									(o = t.cloneNode(!1)),
										i.setAttrib(o, "id", ""),
										r.hasChildNodes()
											? (o.appendChild(r.firstChild), r.appendChild(o))
											: ((s = o), r.appendChild(o));
								}
					...
					function h(t) {
						var n, r, i;
						if (3 == E.nodeType && (t ? S > 0 : S < E.nodeValue.length)) return !1;
						if (E.parentNode == T && O && !t) return !0;
						if (t && 1 == E.nodeType && E == T.firstChild) return !0;
						if (
							"TABLE" === E.nodeName ||
							(E.previousSibling && "TABLE" == E.previousSibling.nodeName)
						)
							return (O && !t) || (!O && t);
						for (
							n = new e(E, T),
								3 == E.nodeType &&
									(t && 0 === S ? n.prev() : t || S != E.nodeValue.length || n.next());
							(r = n.current());
							...
							if (1 === r.nodeType) {
								if (
									...
									((i = r.nodeName.toLowerCase()), c[i] && "br" !== i)
								)
									return !1;
					...
					function g(e, n) {
						var r,
							...
							f = P || "P";
						if (
							((o = i.getParent(e, i.isBlock)),
							(d = t.getBody().nodeName.toLowerCase()),
							!o || !u(o))
						) {
							...
							if (a && l.isValidChild(d, f.toLowerCase())) {
								for (
									r = i.create(f), a.parentNode.insertBefore(r, a), s = a;
									s && !i.isBlock(s);
					...
					function b() {
						...
						E &&
							...
							i.remove(r),
							t
								? (_.setStartBefore(e), _.setEndBefore(e))
								: (_.setStartAfter(e), _.setEndAfter(e)),
							o.setRng(_),
							s.add();
					}
					function C(e) {
					...
					function w(e) {
						...
						n ||
							(e.normalize(),
							(t = e.lastChild),
							(!t || /^(left|right)$/gi.test(i.getStyle(t, "float", !0))) &&
								i.add(e, "br"));
					}
					var _ = o.getRng(!0),
						N,
					...
					if (
						...
						((E = _.startContainer),
						(S = _.startOffset),
						(P = (a.force_p_newlines ? "p" : "") || a.forced_root_block),
						(P = P ? P.toUpperCase() : ""),
						(R = i.doc.documentMode),
						(A = r.shiftKey),
						1 == E.nodeType &&
							E.hasChildNodes() &&
							((O = S > E.childNodes.length - 1),
							(E = E.childNodes[Math.min(S, E.childNodes.length - 1)] || E),
							(S = O && 3 == E.nodeType ? E.nodeValue.length : 0)),
						(k = x(E)))
					) {
						...
						if (
							(((P && !A) || (!P && A)) && (E = g(E, S)),
							(T = i.getParent(E, i.isBlock)),
							(M = T ? i.getParent(T.parentNode, i.isBlock) : null),
							(D = T ? T.nodeName.toUpperCase() : ""),
							(L = M ? M.nodeName.toUpperCase() : ""),
							"LI" != L || r.ctrlKey || ((T = M), (D = L)),
							"LI" == D)
						) {
						...
						(P && T === t.getBody()) ||
							((P = P || "P"),
							h()
								? ((B = /^(H[1-6]|PRE|FIGURE)$/.test(D) && "HGROUP" != L ? m(P) : m()),
								  a.end_container_on_empty_block && u(M) && i.isEmpty(T)
										? (B = i.split(M, T))
										: i.insertAfter(B, T),
								  p(B))
								: h(!0)
								? ((B = T.parentNode.insertBefore(m(), T)), d(B))
								: ((N = _.cloneRange()),
								  N.setEndAfter(T),
								  (H = N.extractContents()),
								  C(H),
		...
		r(L, [N, h, f], function (e, n, r) {
			...
			return function (n) {
				...
				function g(e, r, i) {
					return (
						r === t && (r = f), i === t && (i = null), n.getDoc().execCommand(e, r, i)
					);
				}
				function v(e) {
					return k.match(e);
				...
				o(this, {
					...
					h({
						...
						"Cut,Copy,Paste": function (e) {
							...
							(r || !t.queryCommandSupported(e)) &&
								n.windowManager.alert(
						...
						FontSize: function (e, t, n) {
							...
							n >= 1 &&
								7 >= n &&
								((i = l(N.font_size_style_values)),
								(r = l(N.font_size_classes)),
								(n = r ? r[n - 1] || n : i[n - 1] || n)),
								y(e, n);
						},
						...
						mceCleanup: function () {
							var e = w.getBookmark();
							n.setContent(n.getContent({ cleanup: d }), { cleanup: d }),
								w.moveToBookmark(e);
						},
						...
						mceInsertContent: function (t, r, i) {
							...
							if (
								...
								(f = { content: i, format: "html", selection: !0 }),
								...
								(l = w.getNode()),
								(f = { context: l.nodeName.toLowerCase() }),
								(d = a.parse(i, f)),
								(v = d.lastChild),
								"mce_marker" == v.attr("id"))
							)
							...
							(p = x.get("mce_marker")),
								(m = x.getRect(p)),
								(h = x.getViewPort(n.getWin())),
								(m.y + m.h > h.y + h.h || m.y < h.y || m.x > h.x + h.w || m.x < h.x) &&
									((C = u ? n.getDoc().documentElement : n.getBody()),
									(C.scrollLeft = m.x),
									(C.scrollTop = m.y - h.h + 25)),
								(g = x.createRng()),
								(v = p.previousSibling),
								v && 3 == v.nodeType
									? (g.setStart(v, v.nodeValue.length),
									  u ||
											((y = p.nextSibling),
											y &&
												3 == y.nodeType &&
												(v.appendData(y.data), y.parentNode.removeChild(y))))
									: (g.setStartBefore(p), g.setEndBefore(p)),
								x.remove(p),
								w.setRng(g),
								n.fire("SetContent", f),
								n.addVisual();
						...
						"Indent,Outdent": function (e) {
							...
							(t = N.indentation),
								(n = /[a-z%]+$/i.exec(t)),
								(t = parseInt(t, 10)),
								p("InsertUnorderedList") || p("InsertOrderedList")
									? g(e)
									: (N.forced_root_block ||
											x.getParent(w.getNode(), x.isBlock) ||
											k.apply("div"),
									  i(w.getSelectedBlocks(), function (i) {
											var o;
											"LI" != i.nodeName &&
												((o =
													"rtl" == x.getStyle(i, "direction", !0)
														? "paddingRight"
														: "paddingLeft"),
												"outdent" == e
													? ((r = Math.max(0, parseInt(i.style[o] || 0, 10) - t)),
													  x.setStyle(i, o, r ? r + n : ""))
													: ((r = parseInt(i.style[o] || 0, 10) + t + n),
													  x.setStyle(i, o, r)));
									  }));
						},
						mceRepaint: function () {
						...
						mceReplaceContent: function (e, t, r) {
							n.execCommand(
								"mceInsertContent",
								!1,
								r.replace(/\{\$selection\}/g, w.getContent({ format: "text" }))
							);
						},
						...
						selectAll: function () {
							var e = x.getRoot(),
								t = x.createRng();
							w.getRng().setStart
								? (t.setStart(e, 0), t.setEnd(e, e.childNodes.length), w.setRng(t))
								: g("SelectAll");
						},
					...
					h(
						{
							...
							Outdent: function () {
								...
								if (N.inline_styles) {
									if (
										(e = x.getParent(w.getStart(), x.isBlock)) &&
										parseInt(e.style.paddingLeft, 10) > 0
									)
										return d;
									if (
										(e = x.getParent(w.getEnd(), x.isBlock)) &&
										parseInt(e.style.paddingLeft, 10) > 0
									)
										return d;
								}
								return (
									...
									p("InsertOrderedList") ||
									(!N.inline_styles && !!x.getParent(w.getNode(), "BLOCKQUOTE"))
								);
							},
							"InsertUnorderedList,InsertOrderedList": function (e) {
				...
				return (
					...
					/^([\w\-]+):([^\/]{2})/i.test(e) || /^\s*#/.test(e)
						...
						: (0 === e.indexOf("/") &&
								0 !== e.indexOf("//") &&
								(e =
									(i.base_uri ? i.base_uri.protocol || "http" : "http") +
									"://mce_host" +
									e),
						  /^[\w\-]*:?\/\//.test(e) ||
								((s = i.base_uri ? i.base_uri.path : new t(location.href).directory),
								(e =
									((i.base_uri && i.base_uri.protocol) || "http") +
									"://mce_host" +
									o.toAbsPath(s, e))),
						  ...
						  (a = i.base_uri),
						  a &&
								(o.protocol || (o.protocol = a.protocol),
								o.userInfo || (o.userInfo = a.userInfo),
								o.port || "mce_host" !== o.host || (o.port = a.port),
								(o.host && "mce_host" !== o.host) || (o.host = a.host),
								(o.source = "")),
						  void 0)
				);
			}
				...
				(t.extend = i =
					function (e) {
						function t() {
							...
							if (
								!o &&
								((r = this), r.init && r.init.apply(r, arguments), (t = r.Mixins))
							)
								for (e = t.length; e--; )
						...
						function s(e, t) {
							return function () {
								var n = this,
									...
									i;
								return (
									(n._super = c[e]), (i = t.apply(n, arguments)), (n._super = r), i
								);
							};
						}
						var l = this,
				...
				s = e.extend({
					init: function (e) {
						...
						function u(e, t) {
							...
							do
								if (
									(i.exec(""), (o = i.exec(e)), o && ((e = o[3]), n.push(o[1]), o[2]))
								) {
									r = o[3];
									break;
								}
						...
						for (n = n || this._selectors, r = 0, i = n.length; i > r; r++) {
							for (s = n[r], a = s.length, h = e, m = 0, o = a - 1; o >= 0; o--)
								for (u = s[o]; h; ) {
									for (
										u.psuedo &&
											((p = h.parent().items()), (d = t.inArray(h, p)), (f = p.length)),
											l = 0,
											c = u.length;
										c > l;
										l++
		...
		r(z, [O, f, F, W], function (e, t, n, r) {
			var i = t.makeMap(
					"focusin focusout scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave wheel keydown keypress keyup contextmenu",
					" "
				),
				o = {},
				...
				l = e.extend({
					...
					initLayoutRect: function () {
						var e = this,
							...
							u,
							d;
						(n = e._borderBox = e._borderBox || e.measureBox(i, "border")),
							(e._paddingBox = e._paddingBox || e.measureBox(i, "padding")),
							(e._marginBox = e._marginBox || e.measureBox(i, "margin")),
							(u = t.minWidth),
							(d = t.minHeight),
							(s = u || i.offsetWidth),
							(l = d || i.offsetHeight),
							...
							e
								? ((o = n.deltaW),
								  ...
								  (r.x !== n.x || r.y !== n.y || r.w !== n.w || r.h !== n.h) &&
										((c = l.repaintControls),
										c && c.map && !c.map[t._id] && (c.push(t), (c.map[t._id] = !0)),
										(r.x = n.x),
										(r.y = n.y),
										(r.w = n.w),
										(r.h = n.h)),
						...
						if (i)
							if (e)
								for (s = e.toLowerCase().split(" "), r = s.length; r--; ) {
									...
									if (o)
										if (t) for (l = o.length; l--; ) o[l] === t && o.splice(l, 1);
										else o.length = 0;
								}
							else n._bindings = [];
						return n;
					...
					fire: function (e, t, n) {
						...
						if (
							...
							o._bindings && (l = o._bindings[e]))
						)
							for (
								a = 0, s = l.length;
								s > a && (t.isImmediatePropagationStopped() || l[a].call(o, t) !== !1);
								a++
							);
						if (n !== !1)
					...
					addClass: function (e, t) {
						...
						return (
							...
							r.map[e] ||
								((r.map[e] = e),
								r.push(e),
								n._rendered && ((i = n.getEl(t)), i && (i.className = r.join(" ")))),
							n
						);
					},
					removeClass: function (e, t) {
						...
						return (
							n._rendered && ((o = n.getEl(t)), o && (o.className = r.join(" "))), n
						);
					},
					...
					aria: function (e, t) {
						...
						return "undefined" == typeof t
							...
							: ((n._aria[e] = t),
							  n._rendered &&
									("label" == e && r.setAttribute("aria-labeledby", n._id),
									r.setAttribute("role" == e ? e : "aria-" + e, t)),
							  n);
					},
					encode: function (e, t) {
						return (
							t !== !1 && l.translate && (e = l.translate(e)),
					...
					remove: function () {
						...
						return (
							n &&
								...
								n.items().set(i),
								(n._lastRect = null)),
							e._eventsRoot && e._eventsRoot == e && r.off(t),
							delete l.controlIdLookup[e._id],
					...
					bindPendingEvents: function () {
						...
						if (((o._rendered = !0), (f = o._nativeEvents))) {
							for (
								...
								d = u[l]._eventsRoot;
							for (
								d || (d = u[u.length - 1] || o), o._eventsRoot = d, c = l, l = 0;
								c > l;
								l++
							)
								u[l]._eventsRoot = d;
							for (p in f) {
								...
								"wheel" !== p || s
									? ("mouseenter" === p || "mouseleave" === p
											? d._hasMouseEnter ||
											  (r.on(d.getEl(), "mouseleave", t),
											  r.on(d.getEl(), "mouseover", n),
											  (d._hasMouseEnter = 1))
											: d[p] || (r.on(d.getEl(), p, e), (d[p] = !0)),
									  (f[p] = !1))
									: a
									? r.on(o.getEl(), "mousewheel", i)
									: r.on(o.getEl(), "DOMMouseScroll", i);
							}
						}
					},
					reflow: function () {
		...
		r(U, [z, F, I, V, f, W], function (e, t, n, r, i, o) {
			...
			return e.extend({
						...
						i.each(t, function (t) {
							t &&
								(t instanceof e ||
									...
									(o = i.extend({}, n.settings.defaults, t)),
									(t.type = o.type =
										o.type ||
										t.type ||
										n.settings.defaultType ||
										(o.defaults ? o.defaults.type : null)),
									(t = r.create(o))),
								a.push(t));
						}),
						a
					...
					return (
						e.items().each(function (t, n) {
							...
							t.parent(e),
								t._rendered ||
									((r = e.getEl("body")),
									(i = o.createFragment(t.renderHtml())),
				...
				prepend: function (e) {
					var t = this;
					return (
						t.items().set(t.create(e).concat(t.items().toArray())), t.renderNew()
					);
				},
				insert: function (e, t, n) {
					var r = this,
				...
				u = e.extend({
					...
					init: function (e) {
						function t() {
							...
							n
								? r.css(i, "z-index", n.zIndex - 1)
								: i && (i.parentNode.removeChild(i), (c = !1)),
								(u.currentZIndex = t);
						}
						function n(e, t) {
							for (; e; ) {
						...
						d._super(e),
							...
							e.autohide &&
								(o ||
									((o = function (e) {
										var t,
											r = d.getParentCtrl(e.target);
										for (t = s.length; t--; ) {
											var i = s[t];
											if (i.settings.autohide) {
												if (r && (n(r, i) || i.parent() === r)) continue;
												(e = i.fire("autohide", { target: e.target })),
													e.isDefaultPrevented() || i.hide();
											}
										}
									}),
									r.on(document, "click", o)),
								s.push(d)),
							e.autofix &&
								(a ||
									((a = function () {
							...
							d.on("postrender show", function (e) {
								if (e.control == d) {
									...
									d.modal &&
										...
										(n = n.firstChild),
										d.getContainerElm().appendChild(n),
										setTimeout(function () {
							...
							e.popover &&
								((d._preBodyHtml = '<div class="' + d.classPrefix + 'arrow"></div>'),
			...
			return (
				(u.hideAll = function () {
					for (var e = s.length; e--; ) {
						var t = s[e];
						t.settings.autohide &&
							(t.fire("cancel", {}, !1), t.hide(), s.splice(e, 1));
					}
				}),
				u
			);
			...
			return function (t) {
				function n() {
					if (!m)
						if (((m = []), d.find))
							...
							for (
								var e = d.getEl().getElementsByTagName("*"), t = 0;
								t < e.length;
								t++
							)
				...
				function s() {
					...
					if (!n || ("TEXTAREA" != n.nodeName && "text" != n.type))
						return (
							t.onAction ? t.onAction(h) : e.fire(r(), "click", { keyboard: !0 }), !0
						);
				}
				function l() {
					var e;
				...
				return (
					d.on("keydown", function (e) {
						...
						switch (e.keyCode) {
							...
							case r:
								p &&
									("menuitem" == i() && "menu" == o() ? a("haspopup") && s() : c(1),
									(b = !0));
								break;
							case u:
								f && (c(-1), (b = !0));
			...
			var o = e.extend({
				...
				initLayoutRect: function () {
					...
					e.settings.title &&
						!e._fullscreen &&
						((i = e.getEl("head")),
						(t.headerW = i.offsetWidth),
						(t.headerH = i.offsetHeight),
						(r += t.headerH)),
					...
					return (
						...
						i.title &&
							(o =
								...
								r +
								'close" aria-hidden="true">&times;</button>' +
								'<div id="' +
								n +
								'-dragh" class="' +
								r +
				...
				postRender: function () {
					...
					setTimeout(function () {
						...
						e.find("*").each(function (e) {
							e.canFocus &&
								((o = o || e.settings.autofocus),
								(n = n || e),
								"filepicker" == e.type
									? (t.push(e.getEl("inp")),
									  e.getEl("open") && t.push(e.getEl("open").firstChild))
									: t.push(e.getEl()));
						}),
						e.statusbar &&
							e.statusbar.find("*").each(function (e) {
								e.canFocus &&
									((o = o || e.settings.autofocus), (n = n || e), t.push(e.getEl()));
							}),
						e._super(),
		...
		r(Q, [J], function (e) {
			var t = e.extend({
				...
				Statics: {
					...
					alert: function (e, n) {
						return (
							"string" == typeof e && (e = { text: e }), (e.callback = n), t.msgBox(e)
						);
					},
				...
				(r.windows = i),
					(r.open = function (t, r) {
						...
						return (
							...
							(o.params = r || {}),
							n.nodeChanged(),
							o.renderTo(document.body).reflow()
						);
					}),
			...
			return function (a) {
				...
				function u() {
					function t(e) {
						...
						if (
							(n.collapsed || (e = !0),
							(l = n[(e ? "start" : "end") + "Container"]),
							(c = n[(e ? "start" : "end") + "Offset"]),
							3 == l.nodeType &&
								((r = F.getParent(n.startContainer, F.isBlock)),
								e && (r = F.getNext(r, F.isBlock)),
								!r ||
									(!t() && n.collapsed) ||
									((i = F.create("em", { id: "__mceDel" })),
									P(o.grep(r.childNodes), function (e) {
										i.appendChild(e);
									}),
									r.appendChild(i))),
							(n = F.createRng()),
							...
							for (s = W.getBookmark(); (u = F.get("__mceDel")); ) F.remove(u, !0);
							W.moveToBookmark(s);
						}
					}
				...
				function f() {
					a.on("keydown", function (t) {
						!c(t) &&
							65 == t.keyCode &&
							e.metaKeyPressed(t) &&
							(t.preventDefault(), a.execCommand("SelectAll"));
					});
				}
				function p() {
					a.settings.content_editable ||
						(F.bind(a.getDoc(), "focusin", function () {
							W.setRng(W.getRng());
						}),
						F.bind(a.getDoc(), "mousedown", function (e) {
							e.target == a.getDoc().documentElement &&
								(a.getWin().focus(), W.setRng(W.getRng()));
						}));
				}
				function m() {
					a.on("keydown", function (e) {
				...
				function g() {
					a.on("click", function (e) {
						(e = e.target),
							...
							"A" == e.nodeName && F.hasClass(e, "mce-item-anchor") && W.select(e),
							a.nodeChanged();
					});
				}
				function v() {
					...
					function t() {
						return (
							!W.isCollapsed() &&
							F.getParent(W.getStart(), F.isBlock) !=
								F.getParent(W.getEnd(), F.isBlock)
						);
					}
					a.on("keypress", function (n) {
						var r;
						return c(n) || (8 != n.keyCode && 46 != n.keyCode) || !t()
							? void 0
							: ((r = e()),
				...
				function x() {
					l() > 7 ||
						(s("RespectVisibilityInDesign", !0),
						a.contentStyles.push(".mceHideBrInPre pre br {display: none}"),
						F.addClass(a.getBody(), "mceHideBrInPre"),
				...
				function w() {
					F.bind(a.getBody(), "mouseup", function () {
						var e,
							t = W.getNode();
						"IMG" == t.nodeName &&
							((e = F.getStyle(t, "width")) &&
								(F.setAttrib(t, "width", e.replace(/[^0-9%]+/g, "")),
								F.setStyle(t, "width", "")),
							(e = F.getStyle(t, "height")) &&
								(F.setAttrib(t, "height", e.replace(/[^0-9%]+/g, "")),
								F.setStyle(t, "height", "")));
					});
				}
				function _() {
				...
				function N() {
					a.on("keydown", function (t) {
						...
						if (
							...
							for (
								;
								s && s.parentNode && s.parentNode.firstChild == s && s.parentNode != o;

							)
								s = s.parentNode;
							"BLOCKQUOTE" === s.tagName &&
								(a.formatter.toggle("blockquote", null, s),
								(n = F.createRng()),
								n.setStart(r, 0),
								n.setEnd(r, 0),
								W.setRng(n));
				...
				function k() {
					function e() {
						a._refreshContentEditable(),
							...
							z.object_resizing || s("enableObjectResizing", !1);
					}
				...
				function R() {
					a.on("keydown", function (e) {
						...
						c(e) ||
							e.keyCode != O ||
							((t = a.getDoc().selection.createRange()),
							t &&
								t.item &&
								(e.preventDefault(),
				...
				function A() {
					...
					l() >= 10 &&
						((e = ""),
						P("p div h1 h2 h3 h4 h5 h6".split(" "), function (t, n) {
							e += (n > 0 ? "," : "") + t + ":empty";
						}),
						...
						U.addNodeFilter("noscript", function (e) {
							for (var t = e.length, i, o, a; t--; )
								(i = e[t]),
									(o = e[t].firstChild),
									o
										? (o.value = r.decode(o.value))
										: ((a = i.attributes.map["data-mce-innertext"]),
										  a &&
				...
				function H() {
					...
					function n() {
						...
						a && !e.item && 0 === e.compareEndPoints("StartToEnd", e) && a.select(),
							F.unbind(r, "mouseup", n),
							F.unbind(r, "mousemove", t),
							(a = o = 0);
					}
					var r = F.doc,
						i = r.body,
					...
					(r.documentElement.unselectable = !0),
						F.bind(r, "mousedown contextmenu", function (i) {
							if ("HTML" === i.target.nodeName) {
								if (
									(o && n(), (s = r.documentElement), s.scrollHeight > s.clientHeight)
								)
									return;
								(o = 1),
									(a = e(i.x, i.y)),
				...
				C(),
					...
					d(),
					M(),
					$ && (_(), u(), p(), g(), S(), i.iOS ? (y(), L()) : f()),
					j && i.ie < 11 && (m(), b(), x(), w(), R(), A(), B(), H()),
					q && (m(), h(), v(), k(), E(), T(), D());
			};
		}),
		r(tt, [f], function (e) {
			...
			var r = "__bindings",
				i = e.makeMap(
					"focusin focusout click dblclick mousedown mouseup mousemove mouseover beforepaste paste cut copy selectionchange mouseout mouseenter mouseleave keydown keypress keyup contextmenu dragend dragover draggesture dragdrop drop drag",
					" "
				);
			return {
				fire: function (e, i, o) {
					...
					if (
						...
						for (
							l = 0, c = s.length;
							c > l && ((s[l] = u = s[l]), !i.isImmediatePropagationStopped());
							l++
						)
					...
					(e.altKey || e.ctrlKey || e.metaKey) &&
						n(s, function (n) {
							...
							if (n.ctrl == r && n.alt == e.altKey && n.shift == e.shiftKey)
								return e.keyCode == n.keyCode ||
									(e.charCode && e.charCode == n.charCode)
									? (e.preventDefault(), "keydown" == e.type && n.func.call(n.scope), !0)
									: void 0;
						});
				}),
		...
		r(
			rt,
			[g, y, b, k, N, R, B, H, M, D, L, P, v, u, Z, C, w, et, h, f, tt, nt],
			function (e, n, r, i, o, a, s, l, c, u, d, f, p, m, h, g, v, y, b, C, x, w) {
				function _(e, t) {
					return "selectionchange" == t || "drop" == t
						? e.getDoc()
						: !e.inline && /^mouse|click|contextmenu/.test(t)
						? e.getDoc()
						: e.getBody();
				}
				function N(e, t, r) {
					...
					(o = i.documentBaseUrl = r.documentBaseURL),
						...
						(i.isNotDirty = !0),
						(i.plugins = {}),
						(i.documentBaseURI = new f(t.document_base_url || o, { base_uri: a })),
						(i.baseURI = a),
						(i.contentCSS = []),
						(i.contentStyles = []),
						(i.shortcuts = new w(i)),
					...
					(N.prototype = {
						render: function () {
							function e() {
								...
								n.language &&
									...
									n.language_url && e.add(n.language_url),
									n.theme &&
										"function" != typeof n.theme &&
										"-" != n.theme.charAt(0) &&
										!E.urls[n.theme] &&
										E.load(n.theme, "themes/" + n.theme + "/theme" + i + ".js"),
									C.isArray(n.plugins) && (n.plugins = n.plugins.join(" ")),
									R(n.external_plugins, function (e, t) {
							...
							if (!D.domLoaded)
								return (
									k.bind(window, "ready", function () {
										t.render();
									}),
									void 0
								);
							if (
								((t.editorManager.settings = n), t.getElement() && b.contentEditable)
							) {
								n.inline
									? (t.inline = !0)
								...
								o &&
									...
									n.hidden_input &&
										...
										k.insertAfter(k.create("input", { type: "hidden", name: r }), r),
									(t.formEventDelegate = function (e) {
										t.fire(e.type, e);
									}),
									k.bind(o, "submit reset", t.formEventDelegate),
									t.on("reset", function () {
						...
						init: function () {
							...
							if (
								...
								(n.aria_label =
									n.aria_label ||
									k.getAttrib(r, "aria-label", t.getLang("aria.rich_text_area"))),
								n.theme &&
									("function" != typeof n.theme
										? ((n.theme = n.theme.replace(/-/, "")),
										  ...
										  t.theme.init &&
												t.theme.init(
													t,
													E.urls[n.theme] || t.documentBaseUrl.replace(/\/$/, "")
												))
										: (t.theme = n.theme)),
								R(n.plugins.replace(/\-/g, "").split(/[ ,]/), e),
								t.fire("BeforeRenderUI"),
								n.render_ui &&
									t.theme &&
									...
									"function" != typeof n.theme
										? ((i = n.width || r.style.width || r.offsetWidth),
										  ...
										  (f = /^[0-9\.]+(|px)$/i),
										  f.test("" + i) &&
												(i = Math.max(parseInt(i, 10) + (l.deltaWidth || 0), 100)),
										  f.test("" + o) &&
												(o = Math.max(parseInt(o, 10) + (l.deltaHeight || 0), a)),
										  (l = t.theme.renderUI({
												targetNode: r,
												width: i,
												height: o,
										  ...
										  n.content_editable ||
												(k.setStyles(l.sizeContainer || l.editorContainer, {
													wi2dth: i,
													h2eight: o,
												}),
												(o =
							...
							for (
								document.domain &&
									...
									(t.editorManager.relaxedDomain = document.domain),
							...
							(u = n.body_id || "tinymce"),
								-1 != u.indexOf("=") &&
									((u = t.getParam("body_id", "", "hash")), (u = u[t.id] || u)),
								(d = n.body_class || ""),
								-1 != d.indexOf("=") &&
									((d = t.getParam("body_class", "", "hash")), (d = d[t.id] || "")),
								(t.iframeHTML +=
									'</head><body id="' +
									u +
								...
								t.editorManager.relaxedDomain &&
									(P || (O && parseFloat(window.opera.version()) < 11)) &&
									(c =
						...
						initContentBody: function () {
							...
							n.inline || (t.getElement().style.visibility = t.orgVisibility),
								(P && t.editorManager.relaxedDomain) ||
									n.content_editable ||
									(f.open(),
									f.write(t.iframeHTML),
									f.close(),
									t.editorManager.relaxedDomain &&
										(f.domain = t.editorManager.relaxedDomain)),
								n.content_editable &&
									(t.on("remove", function () {
										var e = this.getBody();
										k.removeClass(e, "mce-content-body"),
											k.removeClass(e, "mce-edit-focus"),
											k.setAttrib(e, "tabIndex", null),
											k.setAttrib(e, "contentEditable", null);
									}),
									k.addClass(o, "mce-content-body"),
									(o.tabIndex = -1),
									(t.contentDocument = f = n.content_document || document),
									(t.contentWindow = n.content_window || window),
									(t.bodyElement = o),
								...
								(p.disabled = !0),
								n.readonly ||
									(p.contentEditable = t.getParam("content_editable_state", !0)),
								(p.disabled = !1),
								(t.schema = new g(n)),
								(t.dom = new e(f, {
									keep_values: !0,
								...
								t.parser.addAttributeFilter("src,href,style", function (e, n) {
									for (var r = e.length, i, o = t.dom, a, s; r--; )
										(i = e[r]),
											...
											i.attributes.map[s] ||
												("style" === n
													? i.attr(s, o.serializeStyle(o.parseStyle(a), i.name))
													: i.attr(s, t.convertURL(a, n, i.name)));
								}),
								...
								n.browser_spellcheck ||
									n.gecko_spellcheck ||
									((f.body.spellcheck = !1), k.setAttrib(p, "spellcheck", "false")),
								t.fire("PostRender"),
								(t.quirks = y(t)),
								...
								(t.initialized = !0),
								R(t._pendingNativeEvents, function (e) {
						...
						focus: function (e) {
							...
							e ||
								...
								i || (b.opera || n.getBody().focus(), n.getWin().focus()),
								(L || i) &&
									((l = n.getBody()),
									l.setActive ? l.setActive() : l.focus(),
									i && r.normalize()),
								a &&
									a.ownerDocument == s &&
									((o = s.body.createControlRange()), o.addElement(a), o.select())),
								n.editorManager.activeEditor != n &&
									((t = n.editorManager.activeEditor) &&
										t.fire("deactivate", { relatedTarget: n }),
									n.fire("activate", { relatedTarget: t })),
								(n.editorManager.activeEditor = n);
						},
						...
						getLang: function (e, n) {
							return (
								this.editorManager.i18n[(this.settings.language || "en") + "." + e] ||
								(n !== t ? n : "{#" + e + "}")
							);
						},
						...
						execCommand: function (e, t, n, r) {
							...
							return (
								/^(mceAddUndoLevel|mceEndUndoLevel|mceBeginUndoLevel|mceRepaint)$/.test(
									...
									i.focus(),
								(r = T({}, r)),
								(r = i.fire("BeforeExecCommand", { command: e, ui: t, value: n })),
								r.isDefaultPrevented()
									? !1
									: (a = i.execCommands[e]) && a.func.call(a.scope, t, n) !== !0
									? (i.fire("ExecCommand", { command: e, ui: t, value: n }), !0)
									: (R(i.plugins, function (r) {
											return r.execCommand && r.execCommand(e, t, n)
												? (i.fire("ExecCommand", { command: e, ui: t, value: n }),
												  (o = !0),
												  !1)
												: void 0;
									  }),
									  o
											? o
											: i.theme && i.theme.execCommand && i.theme.execCommand(e, t, n)
											? (i.fire("ExecCommand", { command: e, ui: t, value: n }), !0)
											: i.editorCommands.execCommand(e, t, n)
											? (i.fire("ExecCommand", { command: e, ui: t, value: n }), !0)
						...
						queryCommandState: function (e) {
							...
							if (!t._isHidden()) {
								if (
									(n = t.queryStateCommands[e]) &&
									((r = n.func.call(n.scope)), r !== !0)
								)
									return r;
						...
						queryCommandValue: function (e) {
							...
							if (!n._isHidden()) {
								if (
									(r = n.queryValueCommands[e]) &&
									((i = r.func.call(r.scope)), i !== !0)
								)
									return i;
								...
								0 === e.length || /^\s+$/.test(e)
									? ((i = n.settings.forced_root_block),
									  i && n.schema.isValidChild(r.nodeName.toLowerCase(), i.toLowerCase())
											...
											: P || (e = '<br data-mce-bogus="1">'),
									  (r.innerHTML = e),
									  n.fire("SetContent", t))
									: ("raw" !== t.format &&
											(e = new o({}, n.schema).serialize(
												n.parser.parse(e, { isRootContent: !0 })
											)),
									  (t.content = H(e)),
									  n.dom.setHTML(r, t.content),
									  t.no_events || n.fire("SetContent", t)),
								t.initial || (n.selection.select(r, !0), n.selection.collapse(!0)),
								t.content
							);
						},
						getContent: function (e) {
						...
						getWin: function () {
							...
							return (
								e.contentWindow ||
									((t = k.get(e.id + "_ifr")), t && (e.contentWindow = t.contentWindow)),
								e.contentWindow
							);
						},
						getDoc: function () {
									...
									switch (e.nodeName) {
										case "TABLE":
											return (
												...
												(t && "0" != t) ||
													(n.hasVisual ? i.addClass(e, o) : i.removeClass(e, o)),
												void 0
											);
										case "A":
											return (
						...
						remove: function () {
							...
							e.removed ||
								((e.removed = 1),
								P && n && n.execCommand("SelectAll"),
								e.save(),
								k.setStyle(e.id, "display", e.orgDisplay),
								e.settings.content_editable ||
									(D.unbind(e.getWin()), D.unbind(e.getDoc())),
								D.unbind(e.getBody()),
								D.unbind(t),
								e.fire("remove"),
						...
						bindNative: function (e) {
							var t = this;
							t.initialized
								? t.dom.bind(_(t, e), e, function (n) {
										t.fire(e, n);
								  })
								: t._pendingNativeEvents
						...
						destroy: function (e) {
							...
							t.destroyed ||
								(L &&
									(D.unbind(t.getDoc()), D.unbind(t.getWin()), D.unbind(t.getBody())),
								e ||
			...
			function n(r) {
				...
				function s(s) {
					...
					var c = s.editor,
						...
						d;
					c.on("init", function () {
						"onbeforedeactivate" in document && t.ie < 11
							? c.dom.bind(c.getBody(), "beforedeactivate", function () {
							...
							: (c.inline || t.ie > 10) &&
							  (c.on("nodechange keyup", function () {
									var e,
							  ...
							  t.webkit &&
									...
									e.DOM.bind(document, "selectionchange", d),
						...
						c.on("focusin", function () {
							...
							c.selection.lastFocusBookmark &&
								(c.selection.setRng(a(c, c.selection.lastFocusBookmark)),
								(c.selection.lastFocusBookmark = null)),
								e != c &&
									(e && e.fire("blur", { focusedEditor: c }),
									(r.activeEditor = c),
									c.fire("focus", { blurredEditor: e }),
									c.focus(!1),
									(r.focusedEditor = c));
						}),
							...
							(c.selection.lastFocusBookmark = o(u)),
								window.setTimeout(function () {
									...
									e != c && (c.selection.lastFocusBookmark = null),
										l(i()) ||
											e != c ||
											(c.fire("blur", { focusedEditor: null }),
				...
				h = {
					...
					init: function (t) {
						...
						var o = this,
							...
							s;
						(o.settings = t),
							c.bind(window, "ready", function () {
								var l, m;
								if ((r(t, "onpageload"), t.types))
									return (
										d(t.types, function (r) {
								...
								if (t.selector)
									return (
										d(c.select(t.selector), function (r) {
											var i = new e(n(r), t, o);
											a.push(i), i.render(1);
										}),
										void 0
								...
								switch (t.mode) {
									case "exact":
										(l = t.elements || ""),
											l.length > 0 &&
												d(u(l), function (n) {
													c.get(n)
														? ((s = new e(n, t, o)), a.push(s), s.render(!0))
														: d(document.forms, function (r) {
									...
									case "specific_textareas":
										d(c.select("textarea"), function (r) {
											(t.editor_deselector && i(r, t.editor_deselector)) ||
												((!t.editor_selector || i(r, t.editor_selector)) &&
													((s = new e(n(r), t, o)), a.push(s), s.render(!0)));
										});
								}
								t.oninit &&
									((l = m = 0),
						...
						if (e) {
							...
							if ((t.activeEditor == i && (t.activeEditor = r[0]), i && !i.removed))
								return (
									i.remove(),
									i.destroy(),
									t.fire("RemoveEditor", { editor: i }),
									r.length || c.unbind(window, "beforeunload", m),
									i
								);
		...
		r(lt, [], function () {
			return {
				send: function (e) {
					function t() {
						!e.async || 4 == n.readyState || r++ > 1e4
							? (e.success && 1e4 > r && 200 == n.status
									? e.success.call(e.success_scope, "" + n.responseText, n, e)
									: e.error &&
									  e.error.call(e.error_scope, r > 1e4 ? "TIMED_OUT" : "GENERAL", n, e),
							  (n = null))
							: setTimeout(t, 10);
					}
					var n,
					...
					if (
						...
						if (
							(n.overrideMimeType && n.overrideMimeType(e.content_type),
				...
				r = e.extend({
					init: function (e) {
						...
						t._super(e),
							...
							e.tooltip &&
								r.tooltips !== !1 &&
								t.on("mouseenter mouseleave", function (n) {
					...
					tooltip: function () {
						var e = this;
						return (
							n || ((n = new t({ type: "tooltip" })), n.renderTo(e.getContainerElm())),
							n
						);
					},
					active: function (e) {
		...
		r(bt, [U], function (e) {
			return e.extend({
				Defaults: { defaultType: "button", role: "toolbar" },
				renderHtml: function () {
					var e = this,
						t = e._layout;
					return (
			...
			return e.extend({
				...
				renderHtml: function () {
					...
					return (
						...
						'" class="' +
						e.classes() +
						'" unselectable="on" aria-labeledby="' +
						t +
						'-al" tabindex="-1">' +
						'<i class="' +
						n +
				...
				postRender: function () {
					...
					return (
						e.on("click", function (t) {
							t.control === e &&
								(e.panel && e.panel.visible() ? e.hidePanel() : e.showPanel());
						}),
						e._super()
					);
				},
			...
			return e.extend({
					...
					n._super(e),
						...
						n.on("click", function (e) {
							for (var t = e.target; t; )
								t.id && -1 != t.id.indexOf("-open") && n.fire("action"),
									(t = t.parentNode);
						}),
						...
						e.placeholder &&
							...
							n.on("focusin", function () {
								n._hasOnChange ||
									(t.on(n.getEl("inp"), "change", function () {
										n.fire("change");
									}),
									(n._hasOnChange = !0)),
									n.hasClass("placeholder") &&
										((n.getEl("inp").value = ""), n.removeClass("placeholder"));
							}),
							n.on("focusout", function () {
								0 === n.value().length &&
									((n.getEl("inp").value = e.placeholder), n.addClass("placeholder"));
							}));
				},
				value: function (e) {
					var t = this;
				...
				repaint: function () {
					...
					return (
						...
						t.css(n.firstChild, { width: o, lineHeight: a }),
						e._super(),
						e
					);
				},
				postRender: function () {
					var e = this;
					return (
						t.on(this.getEl("inp"), "change", function () {
							e.fire("change");
						}),
						e._super()
					);
					...
					return (
						...
						(o || a) &&
							((s =
								...
								'<button id="' +
								t +
								'-action" type="button" hidefocus tabindex="-1">' +
								(o ? '<i class="' + o + '"></i>' : '<i class="' + r + 'caret"></i>') +
								(a ? (o ? " " : "") + a : "") +
								"</button>" +
								"</div>"),
							e.addClass("has-open")),
		...
		r(Nt, [z, X], function (e, t) {
			return e.extend({
				...
				focus: function () {
					var e = this;
					return (
						(e.keyNav = new t({ root: e, enableLeftRight: !0 })),
						e.keyNav.focusFirst(),
						e
					);
				},
			...
			return e.extend({
				postRender: function () {
					function e(e) {
						return (
							1 === e.nodeType &&
							("BR" == e.nodeName || !!e.getAttribute("data-mce-bogus"))
						);
					}
					var n = this,
						r = t.activeEditor;
				...
				preRender: function () {
					...
					n.each(function (n) {
						...
						i &&
							...
							(r.type = "formitem"),
							"undefined" == typeof n.settings.flex && (n.settings.flex = 1),
							e.replace(n, r),
							r.add(n));
					});
				},
				...
				recalc: function (e) {
					...
					for (
						...
						(p = r[t]),
							...
							(g = h.flex),
							(d -= n - 1 > t ? c : 0),
							g > 0 && ((u += g), m[S] && v.push(p), (m.flex = g)),
							(d -= m[k]),
							(y = o[I] + m[P] + o[F]),
							y > _ && (_ = y);
					if (
						((x = {}),
						(x[k] = 0 > d ? i[k] - d + i[B] : i[R] - d + i[B]),
						(x[P] = _ + i[W]),
						(x[H] = i[R] - d),
						(x[z] = _),
						(x.minW = U(x.minW, i.maxW)),
						(x.minH = U(x.minH, i.maxH)),
						(x.minW = V(x.minW, i.startMinWidth)),
						(x.minH = V(x.minH, i.startMinHeight)),
						...
						for (
							...
							(p = r[t]),
								...
								(y = m.maxFlexSize || m[k]),
								"center" === s
									? (x[M] = Math.round(i[D] / 2 - m[L] / 2))
									: "stretch" === s
									? ((x[L] = V(m[P] || 0, i[D] - o[I] - o[F])), (x[M] = o[I]))
									: "end" === s && (x[M] = i[D] - m[L] - o.top),
								m.flex > 0 && (y += Math.ceil(m.flex * C)),
								(x[N] = y),
								(x[E] = w),
								p.layoutRect(x),
								p.recalc && p.recalc(),
			...
			function a(e) {
				function t(t) {
					...
					var r,
						...
						c;
					return (
						(c = e.settings.preview_styles),
						c === !1
							? ""
							: (c ||
									(c =
										"font-family font-size font-weight text-decoration text-transform color background-color border border-radius"),
							  (t = e.formatter.get(t))
									? ((t = t[0]),
									  (r = t.block || t.inline || "span"),
									  (i = o.create(r)),
									  s(t.styles, function (e, t) {
									  ...
									  o.setStyles(i, { position: "absolute", left: -65535 }),
									  e.getBody().appendChild(i),
									  (l = o.getStyle(e.getBody(), "fontSize", !0)),
									  (l = /px$/.test(l) ? parseInt(l, 10) : 0),
									  s(c.split(" "), function (t) {
											var n = o.getStyle(i, t, !0);
											if (
												!(
													("background-color" == t &&
														/transparent|rgba\s*\([^)]+,\s*0\)/.test(n) &&
														((n = o.getStyle(e.getBody(), t, !0)),
														"#ffffff" == o.toHex(n).toLowerCase())) ||
													("color" == t && "#000000" == o.toHex(n).toLowerCase())
												)
											) {
						...
						var n = [],
							o = i(
								e.settings.block_formats ||
									"Paragraph=p;Address=address;Pre=pre;Header 1=h1;Header 2=h2;Header 3=h3;Header 4=h4;Header 5=h5;Header 6=h6"
							);
						return (
							s(o, function (e) {
								n.push({
			...
			return e.extend({
				recalc: function (e) {
					...
					if (
						...
						var M = 0,
							D = t.flexWidths;
						if (D) for (d = 0; d < D.length; d++) M += D[d];
						else M = r;
						var L = A / M;
						for (d = 0; r > d; d++) N[d] += D ? Math.ceil(D[d] * L) : L;
						for (m = g.top, f = 0; n > f; f++) {
							for (
								p = g.left, s = k[f] + H, d = 0;
								r > d && ((u = i[f * r + d]), u);
								d++
							)
								(h = u.settings),
				...
				initLayoutRect: function () {
					...
					return (
						e.settings.multiline &&
							(e.getEl().offsetWidth > t.maxW &&
								((t.minW = t.maxW), e.addClass("multiline")),
							(e.getEl().style.width = t.minW + "px"),
							(t.startMinH = t.h = t.minH = Math.min(t.maxH, e.getEl().offsetHeight))),
						t
					);
				},
				disabled: function (e) {
					...
					return (
						e !== n &&
							(t.toggleClass("label-disabled", e),
							t._rendered && (t.getEl()[0].className = t.classes())),
						t._super(e)
					);
				},
				repaint: function () {
				...
				showMenu: function () {
					...
					return e.menu && e.menu.visible()
						...
						: (e.menu ||
						  ...
						  e.menu.moveRel(e.getEl(), ["bl-tl", "tl-bl"]),
						  void 0);
				},
				hideMenu: function () {
					var e = this;
				...
				postRender: function () {
					...
					return (
						e.on("click", function (t) {
							t.control === e &&
								r(t.target, e.getEl()) &&
								(e.showMenu(), t.keyboard && e.menu.items()[0].focus());
						}),
			...
			return e.extend({
						...
						t.on("mouseenter click", function (n) {
							n.control === t &&
								(e.menu || "click" !== n.type
									...
									: (t.parent().hideAll(), t.fire("cancel"), t.fire("select")));
						}),
				...
				renderHtml: function () {
					var e = this,
						...
						o = e.settings.icon;
					return (
						o && e.parent().addClass("menu-has-icons"),
						...
						'<div id="' +
							...
							("-" !== i ? '<i class="' + o + '"></i>&nbsp;' : "") +
							("-" !== i
								? '<span id="' + t + '-text" class="' + r + 'text">' + i + "</span>"
								: "") +
							(n.shortcut
								? '<div id="' +
								  t +
		...
		r($t, [Ft, g], function (e, t) {
			var n = t.DOM;
			return e.extend({
				Defaults: { classes: "widget btn splitbtn", role: "splitbutton" },
				repaint: function () {
					var e = this,
						t = e.getEl(),
						r = e.layoutRect(),
					...
					return (
						...
						(i = t.firstChild),
						(o = t.lastChild),
						n.css(i, { width: r.w - o.offsetWidth, height: r.h - 2 }),
						n.css(o, { height: r.h - 2 }),
				...
				postRender: function () {
					...
					return (
						e.on("click", function (e) {
							e.control != this ||
								n.getParent(e.target, "." + this.classPrefix + "open") ||
								(e.stopImmediatePropagation(), t.call(this, e));
						}),
						delete e.settings.onclick,
						e._super()
					);
			...
			return e.extend({
				...
				activateTab: function (e) {
					this.activeTabId &&
						...
						e != this.lastIdx &&
							(this.items()[this.lastIdx].hide(), (this.lastIdx = e)),
					...
					(n = r = 0),
						...
						e.items().each(function (e) {
							(e.settings.x = 0),
								...
								(e.settings.w = n),
								(e.settings.h = r),
								e.layoutRect({ x: 0, y: 0, w: n, h: r });
						});
					var i = e.getEl("head").offsetHeight;
					return (
						(e.settings.minWidth = n),
