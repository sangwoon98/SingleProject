...
!(function (b) {
	...
	a.prototype.checkPosition = function () {
		...
		var i = b(document).height(),
			c = this.$window.scrollTop(),
			d = this.$element.offset(),
			j = this.options.offset,
			h = j.bottom,
			f = j.top,
			e = "affix affix-top affix-bottom",
			g;
		if (typeof j != "object") {
			h = f = j;
		}
		...
		g =
			this.unpin != null && c + this.unpin <= d.top
				? false
				: h != null && d.top + this.$element.height() >= i - h
				? "bottom"
				: f != null && c <= f
				? "top"
				: false;
...
!(function (c) {
	...
	b.prototype.close = function (g) {
		...
		c.support.transition && i.hasClass("fade")
			? i.on(c.support.transition.end, f)
			: f();
	};
...
!(function (b) {
	...
	a.prototype.setState = function (c) {
		...
		setTimeout(function () {
			c == "loadingText"
				? e.addClass(f).attr(f, f)
				: e.removeClass(f).removeAttr(f);
		}, 0);
	};
	...
	b.prototype = {
		...
		transition: function (d, e, f) {
			...
			a.support.transition && this.$element.hasClass("collapse")
				? this.$element.one(a.support.transition.end, c)
				: c();
		},
		toggle: function () {
		...
		function (g) {
			var h = a(this),
				...
				d =
					...
					g.preventDefault() ||
					((c = h.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, "")),
				f = a(d).data("collapse") ? "toggle" : h.data();
...
!(function (b) {
	...
	a.prototype = {
		...
		backdrop: function (f) {
			...
			if (this.isShown && this.options.backdrop) {
				...
				this.$backdrop = b('<div class="modal-backdrop ' + d + '" />').appendTo(
					document.body
				);
				this.$backdrop.click(
					this.options.backdrop == "static"
						? b.proxy(this.$element[0].focus, this.$element[0])
						: b.proxy(this.hide, this)
				);
				if (e) {
				...
				if (!this.isShown && this.$backdrop) {
					...
					b.support.transition && this.$element.hasClass("fade")
						? this.$backdrop.one(
								...
								b.proxy(this.removeBackdrop, this)
						  )
						: this.removeBackdrop();
				} else {
					if (f) {
	...
	b.fn.modal = function (c) {
		return this.each(function () {
			var e = b(this),
				f = e.data("modal"),
				d = b.extend({}, b.fn.modal.defaults, e.data(), typeof c == "object" && c);
			if (!f) {
	...
	b(document).on("click.modal.data-api", '[data-toggle="modal"]', function (g) {
		var h = b(this),
			c = h.attr("href"),
			d = b(h.attr("data-target") || (c && c.replace(/.*(?=#[^\s]+$)/, ""))),
			f = d.data("modal")
				? "toggle"
				: b.extend({ remote: !/#/.test(c) && c }, d.data(), h.data());
		g.preventDefault();
...
!(function (b) {
	...
	a.prototype = {
		...
		show: function () {
			var i = this.element,
				c = i.closest("ul:not(.dropdown-menu)"),
		...
		activate: function (f, d, h) {
			var e = d.find("> .active"),
				c = h && b.support.transition && e.hasClass("fade");
			function g() {
...
!(function (b) {
	...
	a.prototype = {
		...
		listen: function () {
			this.$element
				.on("blur", b.proxy(this.blur, this))
				.on("keypress", b.proxy(this.keypress, this))
				.on("keyup", b.proxy(this.keyup, this));
			if (this.eventSupported("keydown")) {
				this.$element.on("keydown", b.proxy(this.keydown, this));
			}
			this.$menu
				.on("click", b.proxy(this.click, this))
				.on("mouseenter", "li", b.proxy(this.mouseenter, this));
		},
			...
			if (this.hasContent() && this.enabled) {
				...
				g =
					typeof this.options.placement == "function"
						? this.options.placement.call(this, h[0], this.$element[0])
