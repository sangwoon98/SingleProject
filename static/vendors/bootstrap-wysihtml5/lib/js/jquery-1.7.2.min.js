			...
			j.removeChild(p),
				...
				f(function () {
					...
					!u ||
						...
						(d.style.cssText =
							s + "width:0;height:0;position:static;top:0;margin-top:" + m + "px"),
						...
						a.getComputedStyle &&
							...
							(b.reliableMarginRight =
								(parseInt(
									(a.getComputedStyle(l, null) || { marginRight: 0 }).marginRight,
									10
								) || 0) === 0)),
				...
				for (k = 0; k < j.length && !c.isPropagationStopped(); k++) {
					...
					for (
						...
						if (
							...
							(c.data = s.data),
								(c.handleObj = s),
								(o = ((f.event.special[s.origType] || {}).handle || s.handler).apply(
									q.elem,
									g
								)),
								o !== b &&
				...
				o = (m.selectors = {
					...
					filter: {
						PSEUDO: function (a, b, c, d) {
							...
							if (e === "contains")
								return (
									(a.textContent || a.innerText || n([a]) || "").indexOf(b[3]) >= 0
								);
							if (e === "not") {
								var g = b[3];
					...
					(j = new f.fx(this, b, i)),
						...
						cm.test(h)
							? ((q =
							  ...
							  q
									? (f._data(this, "toggle" + i, q === "show" ? "hide" : "show"), j[q]())
									: j[h]())
							: ((m = cn.exec(h)),
							  (n = j.cur()),
							  m
