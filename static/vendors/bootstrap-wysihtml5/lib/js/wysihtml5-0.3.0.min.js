			...
			for (a = d.length; h < a; ++h)
				try {
					...
					c(window, "console") &&
						...
						window.console.log("Init listener threw an exception. Continuing.", j);
				}
		}
	}
	function i(a) {
...
rangy.createModule("DomRange", function (b) {
	...
	function v(a) {
		...
		if (
			...
			(!l.arrayContains(G, a.endContainer.nodeType) && !O(a.endContainer, !0)) ||
			!(
				a.startOffset <=
					...
					j = function (d) {
						...
						if (e && e.nodeType == d.nodeType) {
							...
							a == c
								? ((h += b), (c = a))
								: c == d.parentNode &&
								  ((e = l.getNodeIndex(d)), h == e ? ((c = d), (h = j)) : h > e && h--);
						}
					},
					k = !0;
				l.isCharacterDataNode(c)
					? c.length == h && e(c)
					: (0 < h && (k = c.childNodes[h - 1]) && l.isCharacterDataNode(k) && e(k),
					  (k = !this.collapsed));
				k
					? l.isCharacterDataNode(a)
						? 0 == b && j(a)
...
rangy.createModule("WrappedRange", function (b) {
	...
	function a(a, b) {
		...
		m
			...
			: ((c = a.node.childNodes), (c = f < c.length ? c[f] : null), (d = a.node));
	...
	if (
		...
		d.prototype.refresh = function () {
			...
			0 == this.textRange.compareEndPoints("StartToEnd", this.textRange)
				...
				: ((a = c(this.textRange, b, !0, !1)), (b = c(this.textRange, b, !1, !1)));
		...
		? ((y = d),
		  (b.isSelectionValid = function (a) {
				var a = (a || window).document,
					b = a.selection;
				return (
					"None" != b.type || m.getDocument(b.createRange().parentElement()) == a
				);
		  }))
		: t
		? ((y = a),
	...
	var a = {
			1: function (a) {
				...
				i.src &&
					...
					"undefined" !== typeof i.height && f.setAttribute("height", i.height));
				return f;
			},
			3: function (a) {
	...
	b.Selection = Base.extend({
		...
		executeAndRestore: function (a, c) {
			...
			if (h) {
				...
				(caretPlaceholder = this.doc.querySelector("._wysihtml5-temp-placeholder"))
		...
		doMerge: function () {
			for (var a = [], b, c, d = 0, e = this.textNodes.length; d < e; ++d)
				(b = this.textNodes[d]),
					(c = b.parentNode),
					(a[d] = b.data),
					d && (c.removeChild(b), c.hasChildNodes() || c.parentNode.removeChild(c));
	...
	f.prototype = {
		...
		postApply: function (a, b) {
			for (
				...
				if (
					((o = a[w]), (z = this.getAdjacentMergeableTextNode(o.parentNode, !1)))
				) {
					if (
		...
		areElementsMergeable: function (a, b) {
			var d;
			if (
				(d = c.dom.arrayContains(this.tagNames, (a.tagName || "").toLowerCase()))
			)
				if (
					(d = c.dom.arrayContains(this.tagNames, (b.tagName || "").toLowerCase()))
				)
		...
		applyToTextNode: function (a) {
			...
			c.dom.arrayContains(this.tagNames, b.tagName.toLowerCase())
				? this.cssClass &&
				  ...
				  b.className
						? (b.className &&
								(b.className = b.className.replace(this.similarClassRegExp, "")),
						  (b.className += " " + a))
						: (b.className = a))
		...
		exec: function (h, k, j, n, p) {
			...
			if (r)
				...
				h.commands.support(k)
					? e(q, k, j || "DIV", n)
					: ((r = q.createElement(j || "DIV")), n && (r.className = n), f(h, r));
			}
		},
...
(function (b) {
	...
	b.views.Composer = b.views.View.extend({
		...
		_create: function () {
			...
			c.copyAttributes("className spellcheck title lang dir accessKey".split(" "))
		...
		_getLinks: function (a) {
			for (
				var c = (this[a + "Links"] = b.lang
						.array(this.container.querySelectorAll("[data-wysihtml5-" + a + "]"))
						.get()),
					e = c.length,
					f = 0,
					g = (this[a + "Mapping"] = {}),
