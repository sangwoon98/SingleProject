				...
				(this._renderAxis = function (e) {
					...
					r.autoHide &&
						...
						t(this.element)
							...
							.mouseenter(function () {
								r.disabled ||
									(t(this).removeClass("ui-resizable-autohide"), a._handles.show());
							})
							.mouseleave(function () {
								r.disabled ||
									a.resizing ||
				...
				return 2 === arguments.length && "string" == typeof s
					...
					: ((a = s || {}),
					  ...
					  c &&
							...
							"disabled" in a &&
								(a.disabled ? this._disableDatepicker(i) : this._enableDatepicker(i)),
								...
								(O = m ? m.apply(t.input ? t.input[0] : null, [E]) : [!0, ""]),
									...
									(W +=
										...
										(F && !v
											...
											: " " +
											  O[1] +
											  (E.getTime() === $.getTime() ? " " + this._currentClass : "") +
											  (E.getTime() === j.getTime() ? " ui-datepicker-today" : "")) +
										"'" +
										((F && !v) || !O[2]
											? ""
											: " title='" + O[2].replace(/'/g, "&#39;") + "'") +
										...
										(F && !v
											...
											: "<a class='ui-state-default" +
											  (E.getTime() === j.getTime() ? " ui-state-highlight" : "") +
		...
		t.effects.effect.bounce = function (e, i) {
			...
			for (
				...
				(n = {}),
					...
					(d = l ? 2 * d : d / 2);
			l &&
				((n = { opacity: 0 }), (n[v] = (_ ? "-=" : "+=") + d), a.animate(n, g, m)),
				a.queue(function () {
							...
							e.using &&
								(l = function (t) {
									...
									u > p && p > r(i + s) && (h.horizontal = "center"),
										...
										(h.important =
											a(r(i), r(s)) > a(r(n), r(o)) ? "horizontal" : "vertical"),
		...
		t.widget("ui.tabs", {
			...
			_initialActive: function () {
				...
				return (
					...
					i !== !1 &&
						((i = this.tabs.index(this.tabs.eq(i))), -1 === i && (i = s ? !1 : 0)),
					...
					this.anchors.each(function (i, n) {
						...
						s(n)
							...
							: ((r = e._tabId(l)),
							  ...
							  (a = e.element.find(o)),
							  a.length ||
									((a = e._createPanel(r)), a.insertAfter(e.panels[i - 1] || e.tablist)),
