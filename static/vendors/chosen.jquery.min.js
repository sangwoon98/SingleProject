				...
				return (
					...
					(AbstractChosen.prototype.results_option_build = function (a) {
						...
						for (b = "", f = this.results_data, d = 0, e = f.length; e > d; d++)
							(c = f[d]),
								c.group && (c.search_match || c.group_match)
									? (b += this.result_add_group(c))
									: !c.empty && c.search_match && (b += this.result_add_option(c)),
					...
					(AbstractChosen.prototype.winnow_results = function () {
						...
						for (
							this.no_results_clear(),
								d = 0,
								e = this.get_search_text(),
								c = this.search_contains ? "" : "^",
								b = new RegExp(c + e.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"),
								h = new RegExp(e.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), "i"),
								k = this.results_data,
								i = 0,
								j = k.length;
							j > i;
							...
							(a = k[i]),
								a.empty ||
									(a.group && (a.group_match = !1),
									(!a.group || this.group_search) &&
										((a.search_match = !1),
										(a.search_text = a.group ? a.label : a.html),
										(a.search_match = this.search_string_match(a.search_text, b)),
										a.search_match && (d += 1),
										a.search_match
											? (e.length &&
													((f = a.search_text.search(h)),
													(g =
														a.search_text.substr(0, f + e.length) +
														"</em>" +
														a.search_text.substr(f + e.length)),
													(a.search_text = g.substr(0, f) + "<em>" + g.substr(f))),
											  null != a.group_array_index &&
													(this.results_data[a.group_array_index].group_match = !0))
											: null != a.group_array_index &&
											  this.results_data[a.group_array_index].search_match &&
											  (a.search_match = !0)));
						return 1 > d && e.length
					...
					(AbstractChosen.browser_is_supported = function () {
						...
						return "Microsoft Internet Explorer" === window.navigator.appName
							? null !== (a = document.documentMode) && a >= 8
							: !0;
					}),
				...
				return (
					...
					(Chosen.prototype.set_up_html = function () {
						...
						return (
							...
							this.form_field.id.length &&
								(c.id = this.form_field.id.replace(/[^\w]/g, "_") + "_chzn"),
					...
					(Chosen.prototype.register_observers = function () {
						...
						return (
							...
							this.is_multiple
								? this.search_choices.click(function (b) {
										a.choices_click(b);
								  })
						...
						return (
							...
							this.is_disabled
								...
								: (this.container.removeClass("chzn-disabled"),
								  ...
								  this.is_multiple
										? void 0
										: this.selected_item.bind("focus", this.activate_action))
						);
					}),
					...
					(Chosen.prototype.search_results_mousewheel = function (a) {
						...
						return (
							(b =
								-(null != (c = a.originalEvent) ? c.wheelDelta : void 0) ||
								(null != (d = a.originialEvent) ? d.detail : void 0)),
							null != b
								? (a.preventDefault(),
					...
					(Chosen.prototype.test_active_click = function (b) {
						return this.container.is(a(b.target).closest(".chzn-container"))
							? (this.active_field = !0)
							: this.close_field();
					}),
					...
					(Chosen.prototype.results_show = function () {
						return this.is_multiple &&
							...
							? (this.form_field_jq.trigger("liszt:maxselected", { chosen: this }), !1)
					...
					(Chosen.prototype.set_tab_index = function () {
						var a;
						return this.form_field_jq.attr("tabindex")
							? ((a = this.form_field_jq.attr("tabindex")),
							  this.form_field_jq.attr("tabindex", -1),
							  this.search_field.attr("tabindex", a))
							: void 0;
					}),
					(Chosen.prototype.set_label_behavior = function () {
						...
						return (
							...
							this.form_field_label.length > 0
								? this.form_field_label.click(function (a) {
					...
					(Chosen.prototype.choice_destroy = function (a) {
						return this.result_deselect(a.attr("rel"))
							? (this.show_search_field_default(),
							  this.is_multiple &&
									this.choices_count() > 0 &&
