...
*/ (function (e, t) {
				...
				while ((o = s[n++]) && !e.isPropagationStopped()) {
					...
					while ((i = o.handlers[a++]) && !e.isImmediatePropagationStopped())
						(!e.namespace_re || e.namespace_re.test(i.namespace)) &&
							((e.handleObj = i),
							(e.data = i.data),
							(r = ((b.event.special[i.origType] || {}).handle || i.handler).apply(
								o.elem,
								u
							)),
							r !== t &&
			...
			function vt(e) {
				var t,
					...
					f = [
						function (e, n, r) {
							return (
								(!a && (r || n !== l)) || ((t = n).nodeType ? c(e, n, r) : p(e, n, r))
							);
						},
					];
				for (; o > u; u++)
	...
	b.fn.extend({
		...
		add: function (e, t) {
			var n =
					"string" == typeof e ? b(e, t) : b.makeArray(e && e.nodeType ? [e] : e),
	...
	(At.optgroup = At.option),
		...
		b.fn.extend({
			...
			domManip: function (e, n, r) {
				...
				if (
					m ||
					(!(1 >= p || "string" != typeof g || b.support.checkClone) && Ct.test(g))
				)
				...
				return on(
					...
					r
						? an(
								...
								n,
								r,
								b.support.boxSizing && "border-box" === b.css(e, "boxSizing", !1, i),
								i
						  )
						: 0
				);
