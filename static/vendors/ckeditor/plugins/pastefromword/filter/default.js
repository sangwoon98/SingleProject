...
(function () {
	function z(a) {
		for (var a = a.toUpperCase(), c = A.length, b = 0, f = 0; f < c; ++f)
			for (var d = A[f], e = d[1].length; a.substr(0, e) == d[1]; a = a.substr(e))
				b += d[0];
		return b;
	}
	function B(a) {
						...
						style: function (a) {
							if (CKEDITOR.env.gecko) {
								var a =
										(a = a
											.onlyChild()
											.value.match(/\/\* Style Definitions \*\/([\s\S]*?)\/\*/)) && a[1],
									c = {};
								a &&
									(a
										.replace(/[\n\r]/g, "")
										.replace(/(.+?)\{(.+?)\}/g, function (a, b, d) {
											for (var b = b.split(","), a = b.length, q = 0; q < a; q++)
												CKEDITOR.tools
													.trim(b[q])
													.replace(/^(\w+)(\.[\w-]+)?$/g, function (a, b, q) {
														b = b || "*";
									...
									(e.applyStyleFilter = function (a) {
										var b = c["*"] ? "*" : a.name,
											q = a.attributes && a.attributes["class"];
										b in c &&
											((b = c[b]),
											"object" == typeof b && (b = b[q]),
											b && a.addStyle(b, !0));
									}));
							}
							return !1;
						...
						p: function (a) {
							...
							r(a) ||
								(d.enterMode == CKEDITOR.ENTER_BR
									...
									: g(d["format_" + (d.enterMode == CKEDITOR.ENTER_P ? "p" : "div")])(
											a
									  ));
						},
						div: function (a) {
										...
										[
											...
											function (a, b, c) {
												if (b.name in { p: 1, div: 1 }) {
													b =
														"ltr" == d.contentsLangDirection ? "margin-left" : "margin-right";
