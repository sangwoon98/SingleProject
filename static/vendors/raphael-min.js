	...
	var e,
		...
		u = function (t, i) {
			...
			for (var g = 0, v = o.length; v > g; g++)
				"zIndex" in o[g] &&
					(c.push(o[g].zIndex), 0 > o[g].zIndex && (f[o[g].zIndex] = o[g]));
			for (c.sort(l); 0 > c[h]; )
	...
	(function (t, e) {
			...
			for (v = 0; l > v; v++)
				for (var y = 0; u > y; y++) {
					var m = f[v],
						...
						_ = p[y],
						w = p[y + 1],
						k = 0.001 > V(b.x - m.x) ? "y" : "x",
						C = 0.001 > V(w.x - _.x) ? "y" : "x",
					...
					if (B) {
						...
						S >= 0 &&
							...
							T >= 0 &&
							1 >= T &&
							(i ? g++ : g.push({ x: B.x, y: B.y, t1: S, t2: T }));
					}
				}
			return g;
		}
								...
								default:
									for (
										j = [][E](l[C]),
											q = [][E](x[C]),
											m[C] = [],
											_ = i.paper.customAttributes[C].length;
										_--;
		...
		(r.color = function (t) {
			...
			(r.getRGB = a(function (t) {
				...
				!(ae[B](t.toLowerCase().substring(0, 2)) || "#" == t.charAt()) &&
					(t = be(t));
				var e,
					i,
					n,
			...
			(r.parsePathString = function (t) {
				...
				var i = {
					...
					n = [];
				return (
					r.is(t, H) && r.is(t[0], H) && (n = Ae(t)),
					n.length ||
						z(t).replace(oe, function (t, e, r) {
							var a = [],
								s = e.toLowerCase();
							if (
			...
			(r.parseTransformString = a(function (t) {
				...
				var e = [];
				return (
					r.is(t, H) && r.is(t[0], H) && (e = Ae(t)),
					e.length ||
						z(t).replace(le, function (t, r, i) {
							var n = [];
							j.call(r),
		...
		var Te = (r.pathBBox = function (t) {
				...
				for (var r, n = 0, a = 0, s = [], o = [], l = 0, h = t.length; h > l; l++)
					if (((r = t[l]), "M" == r[0]))
						...
						(s = s[E](u.min.x, u.max.x)),
							(o = o[E](u.min.y, u.max.y)),
							(n = r[5]),
							(a = r[6]);
					}
				var c = O[N](0, s),
			...
			Pe = function (t, e, r, i, n, s, o, l, h, u) {
				...
				if (u) (C = u[0]), (B = u[1]), (w = u[2]), (k = u[3]);
					...
					var m = r * r,
						...
						_ =
							(s == o ? -1 : 1) *
							q.sqrt(V((m * b - m * x * x - b * v * v) / (m * x * x + b * v * v))),
						w = (_ * r * x) / i + (t + l) / 2,
						k = (_ * -i * v) / r + (e + h) / 2,
				...
				if (V(S) > f) {
					...
					(B = C + f * (o && B > C ? 1 : -1)),
						(l = w + r * q.cos(B)),
						(h = k + i * q.sin(B)),
						(d = Pe(l, h, r, i, n, 0, o, A, N, [B, T, w, k]));
				}
				S = B - C;
				var L = q.cos(C),
					M = q.sin(C),
			...
			Fe = a(function (t, e, r, i, n, a, s, o) {
				...
				return (
					...
					f > 0 &&
						1 > f &&
						((l = ze(t, e, r, i, n, a, s, o, f)), g.push(l.x), d.push(l.y)),
					p > 0 &&
						1 > p &&
						((l = ze(t, e, r, i, n, a, s, o, p)), g.push(l.x), d.push(l.y)),
					(h = a - 2 * i + e - (o - 2 * a + i)),
					(u = 2 * (i - e) - 2 * (a - i)),
					(c = e - i),
					(f = (-u + q.sqrt(u * u - 4 * h * c)) / 2 / h),
								...
								switch ((!(t[0] in { T: 1, Q: 1 }) && (e.qx = e.qy = null), t[0])) {
									...
									case "T":
										(e.qx = e.x + (e.x - (e.qx || e.x))),
											...
											(t = ["C"][E](Me(e.x, e.y, e.qx, e.qy, t[1], t[2])));
										break;
									case "Q":
										(e.qx = t[1]),
											(e.qy = t[2]),
											(t = ["C"][E](Me(e.x, e.y, t[1], t[2], t[3], t[4])));
										break;
									case "L":
			...
			Oe = (r._equaliseTransform = function (t, e) {
				...
				for (
					...
					if (
						...
						return;
					for (l[u] = [], h[u] = [], i = 0, n = D(a.length, s.length); n > i; i++)
			...
			(function (t) {
				...
				(t.add = function (t, e, r, i, n, a) {
					...
					(t.split = function () {
						...
						return (
							0 > s
								? ((t.rotate = r.deg(q.acos(s))), 0 > a && (t.rotate = 360 - t.rotate))
					...
					(t.toTransformString = function (t) {
						...
						return e.isSimple
							? ((e.scalex = +e.scalex.toFixed(4)),
							  ...
							  (e.dx || e.dy ? "t" + [e.dx, e.dy] : M) +
									(1 != e.scalex || 1 != e.scaley
										? "s" + [e.scalex, e.scaley, 0, 0]
										: M) +
									(e.rotate ? "r" + [e.rotate, 0, 0] : M))
							: "m" +
									[
										this.get(0),
										this.get(1),
						...
						? function (t, e, r, i) {
								...
								return function () {
									return (
										...
										L && I[e] && t.removeEventListener(I[e], n, !1),
										!0
									);
								};
						  }
		...
		(Je.data = function (t, i) {
			...
			(Je.removeData = function (t) {
				return (
					null == t ? (ue[this.id] = {}) : ue[this.id] && delete ue[this.id][t], this
				);
			}),
			(Je.getData = function () {
				return i(ue[this.id] || {});
		...
		(Je.drag = function (t, i, n, a, s, o) {
			...
			return (
				(this._drag = {}), tr.push({ el: this, start: l }), this.mousedown(l), this
			);
		}),
			...
			(_.set = function (t) {
				...
				var e = new fr(t);
				return (
					this.__set__ && this.__set__.push(e), (e.paper = this), (e.type = "set"), e
				);
			}),
				...
				return function (i, n, a) {
					...
					return (
						...
						(u = t
							...
							: e
							? f
							: r.findDotsAtSegment(s, o, l[0], l[1], l[2], l[3], l[4], l[5], 1)),
		...
		var or = (r.easing_formulas = {
			...
			elastic: function (t) {
				return t == !!t
					? t
					: Y(2, -10 * t) * q.sin(((t - 0.075) * 2 * G) / 0.3) + 1;
			},
			bounce: function (t) {
				var e,
					r = 7.5625,
				...
				for (var t = +new Date(), i = 0; lr.length > i; i++) {
					...
					if (!n.el.removed && !n.paused) {
						...
						if (
							(n.initstatus
								? ((o =
										((n.initstatus * n.anim.top - n.prev) / (n.percent - n.prev)) * l),
								  (n.status = n.initstatus),
								  delete n.initstatus,
								  n.stop && lr.splice(i--, 1))
								: (n.status = (n.prev + (n.percent - n.prev) * (o / l)) / n.anim.top),
							!(0 > o))
						)
							if (l > o) {
								var v = h(o / l);
		...
		return (
			...
			(r.registerFont = function (t) {
				...
				if (
					(this.fonts[r] ? this.fonts[r].push(e) : (this.fonts[r] = [e]), !t.svg)
				) {
			...
			(_.getFont = function (t, e, i, n) {
				if (
					...
					(i = i || "normal"),
					(e =
						+e || { normal: 400, bold: 700, lighter: 300, bolder: 800 }[e] || 400),
					r.fonts)
				) {
					var a = r.fonts[t];
					if (!a) {
						var s = RegExp(
							"(^|\\s)" + t.replace(/[^\w\d\s+!~.:_-]/g, M) + "(\\s|$)",
							"i"
						);
				...
				if (r.svg) {
					...
					var v = function (i, n) {
						...
						x = function (t, n) {
							...
							return (
								v(d, { fill: "url(#" + u + ")", opacity: 1, "fill-opacity": 1 }),
								(x.fill = c),
								(x.opacity = 1),
								(x.fillOpacity = 1),
								1
							...
							if ("path" == i.type) {
								...
								if (
									...
									r._g.doc.getElementById(S)
										? g[S]++
										: (p.defs.appendChild(
												v(v("path"), { "stroke-linecap": "round", d: d[w], id: S })
										  ),
										  (g[S] = 1));
									var A,
										N = r._g.doc.getElementById(T);
									N
										? (g[T]++, (A = N.getElementsByTagName("use")[0]))
										: ((N = v(v("marker"), {
												id: T,
												markerHeight: C,
												markerWidth: k,
									...
									a
										? ((s = i._.arrows.startdx * b || 0),
										  (o = r.getTotalLength(m.path) - E * b))
										: ((s = E * b),
										  (o = r.getTotalLength(m.path) - (i._.arrows.enddx * b || 0))),
										(u = {}),
										(u["marker-" + x] = "url(#" + T + ")"),
									...
									a
										...
										: ((s = 0),
										  (o = r.getTotalLength(m.path) - (i._.arrows.enddx * b || 0))),
										i._.arrows[x + "Path"] && v(y, { d: r.getSubpath(m.path, s, o) }),
							...
							for (var d in a)
								if (a[t](d)) {
									...
									switch (((u[d] = g), d)) {
										...
										case "clip-rect":
											...
											if (4 == k.length) {
												...
												var B = v("clipPath"),
													S = v("rect");
												(B.id = r.createUUID()),
													v(S, { x: k[0], y: k[1], width: k[2], height: k[3] }),
													B.appendChild(S),
													i.paper.defs.appendChild(B),
													v(l, { "clip-path": "url(#" + B.id + ")" }),
													(i.clip = S);
											}
											if (!g) {
										...
										case "path":
											"path" == i.type &&
												(v(l, { d: g ? (u.path = r._pathToAbsolute(g)) : "M0,0" }),
												(i._.dirty = 1),
												i._.arrows &&
													("startString" in i._.arrows && m(i, i._.arrows.startString),
										...
										case "stroke-width":
											(1 != i._.sx || 1 != i._.sy) && (g /= s(o(i._.sx), o(i._.sy)) || 1),
												i.paper._vbSize && (g *= i.paper._vbSize),
												l.setAttribute(d, g),
										...
										case "fill-opacity":
											if (u.gradient) {
												(M = r._g.doc.getElementById(
													...
													M &&
														((P = M.getElementsByTagName("stop")),
														v(P[P.length - 1], { "stop-opacity": g }));
												break;
											}
										default:
					...
					(B.prototype = S),
						...
						(r._engine.path = function (t, e) {
							...
							var i = new B(r, e);
							return (
								(i.type = "path"), w(i, { fill: "none", stroke: "#000", path: t }), i
							);
						}),
						...
						(S.show = function () {
							return (
								!this.removed && this.paper.safari((this.node.style.display = "")), this
							);
						}),
						(S.remove = function () {
							...
							return (
								...
								1 == e
									...
									: ((l.style.cssText = h + "position:relative"),
									  e.firstChild ? e.insertBefore(l, e.firstChild) : e.appendChild(l)),
								(e = new r._Paper()),
								(e.width = a),
								(e.height = s),
								(e.canvas = l),
						...
						(r._engine.setViewBox = function (t, e, r, i, n) {
							...
							var a,
								o,
								l = s(r / this.width, i / this.height),
								h = this.top,
								c = n ? "meet" : "xMinYMin";
							for (
								null == t
									...
									: ((this._vbSize = l), (a = t + f + e + f + r + f + i)),
									v(this.canvas, { viewBox: a, preserveAspectRatio: c });
								l && h;
						...
						(r.prototype.renderfix = function () {
							...
							(n || a) &&
								(n &&
									((this._left = (this._left + n) % 1), (r.left = this._left + "px")),
				...
				if (r.vml) {
						...
						T = function (n, l) {
							...
							if ("clip-rect" in l) {
								...
								if (4 == M.length) {
									...
									var P = c.clipRect || r._g.doc.createElement("div"),
										z = P.style;
									(z.clip = r.format("rect({1}px {2}px {3}px {0}px)", M)),
										c.clipRect ||
											((z.position = "absolute"),
											(z.top = 0),
											(z.left = 0),
							...
							if (
										...
										(R.color = r.getRGB(l.fill).hex),
											...
											r.getRGB(l.fill).error &&
												(y.type in { circle: 1, ellipse: 1 } ||
													"r" != e(l.fill).charAt()) &&
												A(y, l.fill, R) &&
												((f.fill = "none"), (f.gradient = l.fill), (R.rotate = !1));
								}
								...
								if (
									...
									O.dashstyle = W[t](l["stroke-dasharray"])
							...
							if ("text" == y.type) {
								...
								(g = X.style),
									...
									(g.fontSize = U * H + "px"),
									y.textpath.string &&
										(X.innerHTML = e(y.textpath.string)
											.replace(/</g, "&#60;")
											.replace(/&/g, "&#38;")
											.replace(/\n/g, "<br>"));
					...
					(N.prototype = E),
						...
						(E.transform = function (t) {
							...
							n && (i = t = e(t).replace(/\.{3}|\u2026/g, this._.transform || d)),
						...
						(E.blur = function (t) {
							...
							return (
								...
								0 !== +t
									? ((this.attrs.blur = t),
									  (e.filter = i + p + f + ".Blur(pixelradius=" + (+t || 1.5) + ")"),
						...
						(r._engine.text = function (t, i, n, s) {
							...
							(i = i || 0),
								(n = n || 0),
								(s = s || ""),
								(l.v = r.format("m{0},{1}l{2},{1}", a(i * b), a(n * b), a(i * b) + 1)),
								(l.textpathok = !0),
								(h.string = e(s)),
								(h.on = !0),
								(o.style.cssText = m),
						...
						(r._engine.setViewBox = function (t, e, i, n, a) {
							...
							return (
								...
								(this._viewBoxShift = { dx: -t, dy: -e, scale: c }),
